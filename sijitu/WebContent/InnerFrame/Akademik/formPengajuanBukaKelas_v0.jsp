...
*/
	...
	//System.out.println("kode_kampus="+kodeKampus);
	String callerPage = request.getParameter("callerPage");
	String backTo= request.getParameter("backTo");
	//overide
	backTo="get.notifications";
	if(backTo!=null) {
...
<!--   include file="IndexAkademikPengajuanSubMenu.jsp" % -->
	<ul>
		<li><a href="#" onclick="location.href='get.listScope?scope=reqBukaKelas&callerPage=null&cmd=bukakelas&atMenu=bukakelas&backTo=<%=backTo %>'" target="_self">BACK<span>&nbsp</b></span></a></li>
	</ul>
