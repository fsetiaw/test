...
<div id="header">
	...
	%>
		<li><a href="get.listKelas?kdpst_nmpst=<%=kdpst_nmpst %>" target="inner_iframe">TAMBAH / EDIT<span>MATA KULIAH</span></a></li>
...
<div class="colmask fullpage">
	...
	<section style="text-align:center;background:#eee;font-size:2em;color:#369;font-weight:bold">
		...
		<table align="center" border="1" style="color:#000;width:800px;background:#d9e1e5;">	
			<tr>
				<td style="background:#369;color:#fff;text-align:center;font-size:1.5em" colspan="4"><b>FORM MATA KULIAH <%=nmpst %></b></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<%
					...
					if(nakmk_1!=null) {
				%>
				<td><input type="text"  name="nakmk" value="<%=nakmk_1 %>" style="width:99%"/></td>
				<%		
					}
					else {
				%>
		...
		<%
			...
			<tr>
				<td style="background:#369;color:#fff;text-align:center;font-size:1.5em" colspan="8"><b>LIST MATA KULIAH <%=nmpst %></b></td>
			</tr>
			<tr>
				...
				<tr>	
					...
					<td style="width:35%;"><b><%=nakmk1 %><input type="hidden" value="<%=nakmk1%>" name="nakmk_1" /></b></td>
