...
Vector v_header= (Vector)request.getAttribute("v_header");
Vector v_body= (Vector)request.getAttribute("v_body");
if(v_header==null || (v_header!=null && v_header.size()<1)) {
	v_header= (Vector)session.getAttribute("v_header");
}
else {
	session.setAttribute("v_header",v_header);	
}

if(v_body==null || (v_body!=null && v_body.size()<1)) {
	v_body= (Vector)session.getAttribute("v_body");
}
else {
	session.setAttribute("v_body",v_body);	
}
...
<br />
<jsp:include page="hamburger_menu_2v.jsp" flush="true" />
