...
%>
<jsp:include page="hamburger_menu_v2.jsp" flush="true" />
<br/>
<%
...
%>
	<thead>
		<tr>
		<th style="padding:0 5px;width:5%;border:1px solid #8AA2A4">
			NO
		</th>
<%
...
%>		
			<th style="padding:0 5px;width:<%=lebar%>%;text-align:<%=teks_align%>;border:1px solid #8AA2A4">
				<%=sth.nextToken() %>
			</th>
<%
		}
