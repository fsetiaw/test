...
String aspti = Checker.getAspti(npm);
String aspst = Checker.getAspst(npm);
%>	
</head>
			...
			<div class="tile-container">
				<div class="tile-wide bg-orange fg-white" data-role="tile">
		         	<div class="tile-content image-set">
		           		<a href="go.defaultVprofileRoute?id_obj=<%=id_obj%>&nmm=<%=nmm%>&npm=<%=npm %>&obj_lvl=<%=obj_lvl %>&kdpst=<%=kdpst %>&aspti=<%=aspti %>&aspst=<%=aspst %>&cmd=edit_sksdi&fwdTo=toNonJsp.gatewayMhsPindahan&fwdPg=<%=beans.setting.Constants.getRootWeb()+"" %>${PageContext.ServletContext.ContextPath}/InnerFrame/formInputKrsPindahan.jsp" target="inner_iframe"><img src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/buku.jpg" data-role="fitImage" data-format="fill"></a>
		          	...
		          	<div style="margin:15px 0 0 110px;position: absolute;">   
		                <p class="no-margin text-shadow" style="color:#393939"><span class="text-bold">MATAKULIAH P.T. ASAL </span></p>
		         	</div>
		      	</div>
		      	<div class="tile-wide bg-orange fg-white" data-role="tile">
		         	<div class="tile-content image-set">
		           		<a href="go.defaultVprofileRoute?id_obj=<%=id_obj%>&nmm=<%=nmm%>&npm=<%=npm %>&obj_lvl=<%=obj_lvl %>&kdpst=<%=kdpst %>&aspti=<%=aspti %>&aspst=<%=aspst %>&cmd=penyetaraan&fwdTo=toNonJsp.gatewayMhsPindahan&fwdPg=<%=beans.setting.Constants.getRootWeb()+"" %>${PageContext.ServletContext.ContextPath}/InnerFrame/formPenyetaraan.jsp" target="inner_iframe"><img src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/total-quality-quality-assurance.jpg" data-role="fitImage" data-format="fill"></a>
		                	<!--  a href="<Constants.getRootWeb() %>/InnerFrame/Keu/requestKeuAprovalForm.jsp" target="inner_iframe"><img src="<Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/payment.jpg" data-role="fitImage" data-format="fill"></a -->
		           	</div>
		          	<div style="margin:95px 0 0 10px;position: absolute;">   
		                <p class="no-margin text-shadow" style="color:#393939">PENYETARAAN<br/><span class="text-bold"> MATAKULIAH </span><br/>P.T ASAL</p>
		         	</div>
		      	</div>
			</div>
		</div>	
