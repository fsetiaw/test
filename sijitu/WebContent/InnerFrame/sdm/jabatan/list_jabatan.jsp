			...
			<thead>
				<tr>
					<th colspan="1" style="border-right:none;width:5%;color:#369;background-color:white;text-align: center; padding: 0px 10px;font-size:2em">&nbsp</th>
  					<th colspan="1" style="border-left:none;border-right:none;width:90%;color:#369;background-color:white;text-align: center; padding: 0px 10px;font-size:2em">DAFTAR NAMA JABATAN</th>
  					<th colspan="1" style="border-left:none;width:5%;color:#369;background-color:white;text-align: center; padding: 0px 10px;font-size:2em">
  						<a class="img" href="<%=Constants.getRootWeb() %>/InnerFrame/sdm/jabatan/list_jabatan_edit.jsp?atMenu=edit">
  			...
  			<tbody>
  				<tr>
					...
					<td colspan="2" width="95%" align="left" style="border:none;vertical-align: middle; padding: 0px 5px"><%=alias.toUpperCase() %></td>
				</tr>
  			</tbody>	
<%
			while(li.hasNext()) {
