...
<div class="colmask fullpage">
	<div class="col1">
		...
		<br> <br>
		<form action="go.tambahJabatan" method="post">
<%		
...
<%	
	 ...
	 %>
		...
		<table class="table" style="margin:auto;width:90%" align="center">
			<thead>
				<tr>
  					<th colspan="5" style="color:#369;background-color:white;text-align: center; padding: 0px 10px;font-size:2em">FORM TAMBAH JABATAN</th>
  				</tr>
  				<tr>
  					<th width="30%" style="vertical-align:middle;text-align: center; padding: 0px 10px;font-size:1em">POSISI JABATAN</th>
  					<th width="50%" style="vertical-align:middle;text-align: center; padding: 0px 10px;font-size:1em">NAMA UNIT/BIRO/DEPARTEMEN/BIDANG/JABATAN</th>
  					<th width="20%" style="vertical-align:middle;text-align: center; padding: 0px 10px;font-size:1em">URUTAN POSISI JABATAN</th>
  				</tr>
  			</thead>
  			<tbody>
  				<tr>
  					<td align="center" style="border:none;vertical-align: middle; padding: 0px 5px">
  						<select name="posisi_jabatan" style="width:99%;text-align-last:center;border:none;height:45px">
  							<option value="null">Biarkan kosong</option>
  						<%
  						String tkn_posisi_jabatan = Checker.getListPosisiJabatan();
  						if(!Checker.isStringNullOrEmpty(tkn_posisi_jabatan)) {
  							StringTokenizer st = new StringTokenizer(tkn_posisi_jabatan,"~");
  							while(st.hasMoreTokens()) {
  								String tkn_jab = st.nextToken().toUpperCase();
  						%>
  							<option value="<%=tkn_jab%>"><%=tkn_jab%></option>
  						<%		
  							}
  						}
  						%>	
					...
					<td align="center" style="border:none;vertical-align: middle; padding: 0px 5px">
					<input type="text" name="nama_jabatan" style="text-align:center;border:none;width:100%;height:45px"/>
					</td>
					<td align="center" style="border:none;vertical-align: middle; padding: 0px 5px">
						<select name="urutan_posisi_jabatan" style="width:99%;text-align-last:center;border:none;height:45px">
  							<option value="null">Biarkan kosong</option>
				...
				<tr>
					<%
					String info = "Note:\njabatan STAFF dapat diisi oleh lebih dari 1 orang\n\nCara Pengisian:\nContoh 1: REKTOR\n&nbsp&nbsp[Biarkan kosong][REKTOR][Biarkan kosong]\n\nContoh 2: WAKIL REKTOR 1\n&nbsp&nbsp[WAKIL][REKTOR][1]\n\nContoh 3: KEPALA TATA USAHA\n&nbsp&nbsp[KEPALA][TATA USAHA][Biarkan kosong]\n\n";
					%>
  					...
  					<th colspan="2" align="left" style="border:none;vertical-align:middle;padding:10px 5px">
  						<input type="submit" value="Tambah Jabatan" style="width:71%;height:45px;font-size:1.5em;color:#646464"/>
  					</th>
  					</thead>
