...
<%
boolean form_urutan = Boolean.parseBoolean(request.getParameter("urutan"));
...
%>		
		...
		<form action="go.updateKelulusanRules" align="center">
		<input type="hidden" name="form_urutan" value="false"/>
