...
*/
	...
	*/
	if(validUsr.isUsrAllowTo_updated("mba", v_npmhs)) {	
	...
	%>		
		<li><a href="get.listScope?scope=mba&callerPage=${pageContext.request.contextPath}/InnerFrame/dashHomeMhs.jsp&atMenu=mba&cmd=mba&scopeType=prodiOnly&id_obj=<%=v_id_obj%>&nmm=<%=v_nmmhs%>&npm=<%=v_npmhs %>&obj_lvl=<%=v_obj_lvl %>&kdpst=<%=v_kdpst %>" target="_self" class="active">BAHAN<span>AJAR</b></span></a></li>		
	<%	
		}
		else {
	%>		
		<li><a href="get.listScope?scope=mba&callerPage=${pageContext.request.contextPath}/InnerFrame/dashHomeMhs.jsp&atMenu=mba&cmd=mba&scopeType=prodiOnly&id_obj=<%=v_id_obj%>&nmm=<%=v_nmmhs%>&npm=<%=v_npmhs %>&obj_lvl=<%=v_obj_lvl %>&kdpst=<%=v_kdpst %>" target="_self">BAHAN<span>AJAR</b></span></a></li>		
	<%
		}	
	}	
