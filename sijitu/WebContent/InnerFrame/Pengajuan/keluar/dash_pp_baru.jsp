...
String awal_pengajuan= request.getParameter("awal_pengajuan");
...
<%
	if(!validUsr.isHakAksesReadOnly("out")) {
...
<div class="colmask fullpage">
	<div class="col1">
		...
		if(v!=null && v.size()>0) {
			...
			<%	
				...
				%>
					...
					<!--  form action="proses.outApproval" method="POST"-->
			...
			//if(!Checker.isStringNullOrEmpty(awal_pengajuan)&&awal_pengajuan.equalsIgnoreCase("true")) {
				//baru dari menu pengajuan = do nothing, biar tidak di redirect bila belum pernah mengajukan
			//}
			//else {
			%>
		...
		//buat session status pengajuan untuk form out page
