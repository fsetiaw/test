		...
		if(v!=null && v.size()>0) {
			...
			<%	
		        ...
		        %>	
		        	...
		        	StringTokenizer st2 = new StringTokenizer(isi_topik_pengajuan,"~");
		        	String tipe_ujian = st2.nextToken();
		        	String judul = st2.nextToken();
		        	String nama_file = st2.nextToken();
		        	
		        	%>
		        	<td style="text-align:center;width:300px" valign="TOP"><%=creator_npm %><br/><%=creator_nmm %><br>Judul Penelitian :<br> 
		        	 <%=judul %>
		        	</td>
		        ...
		        <%
		        	...
		        	if(isi_topik_pengajuan!=null && !Checker.isStringNullOrEmpty(isi_topik_pengajuan)) {
		        		keterangan = "<strong>Judul "+tipe_ujian+" : "+judul+"</strong><br/>";
		        	}
		        	//String 
