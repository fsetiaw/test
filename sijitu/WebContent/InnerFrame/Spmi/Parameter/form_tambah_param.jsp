...
Vector v_list_param = ss.getListParameter();
...
//System.out.println("id_tipe_std form="+id_tipe_std);
//System.out.println("id_versi form="+id_versi);
//System.out.println("id_master_std form="+id_master_std);
//System.out.println("id_std form="+id_std);
//System.out.println("id_std_isi form="+id_std_isi);
...
<div class="colmask fullpage">
	<div class="col1">
		...
		<br> <br>
		<form action="go.tambahParamMutu" method="post">
		...
		<input type="hidden" name="ppepp" value="perencanaan"/>
		

		<table class="table" style="margin:auto;width:90%" align="center">
			<thead>
				<tr>
  					<th colspan="2" style="color:white;text-align: center; padding: 0px 10px;font-size:2em">FORM TAMBAH DOKUMEN BARU</th>
  				</tr>
  			</thead>
  			<tbody>
  				<tr>
  					<%
					String info = "PARAMETER CAPAIAN:\n &nbsp &nbsp &nbsp ";
					%>
					...
					<input type="text" name="nama_param" style="text-align:center;border:none;width:100%;height:45px"/>
					</td>
				</tr>
				<tr>
  					...
  					<thead>
  					<th align="left" style="border:none;vertical-align: middle; padding: 0px 5px" title=""></td>
