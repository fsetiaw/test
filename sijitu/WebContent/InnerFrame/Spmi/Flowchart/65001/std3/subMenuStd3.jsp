...
<%
	...
	%>
	<li><a href="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/<%=target_kdpst %>/std3/indexStd3.jsp?atMenu=isi&target_kdpst=<%=target_kdpst %>" target="inner_iframe" class="active">PERNYATAAN ISI<span>STANDAR</span></a></li>
	<%
		}
		else {
	%>
	<li><a href="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/<%=target_kdpst %>/std3/indexStd3.jsp?atMenu=isi&target_kdpst=<%=target_kdpst %>" target="inner_iframe">PERNYATAAN ISI<span>STANDAR</span></a></li>
	<%		
		}
