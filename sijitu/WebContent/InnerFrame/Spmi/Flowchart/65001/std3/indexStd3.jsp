...
<body>
<div id="header">
	<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std3/subMenuStd3.jsp" />
</div>
...
if(atMenu!=null && atMenu.equalsIgnoreCase("std")) {
	%>
		<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std3/skl.jsp">
...
%>
		<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std3/isi_std/std_proses_karkteristik.htm">
		<jsp:param name="target_kdpst" value="<%=target_kdpst %>"/>
		</jsp:include>
<%	
}
