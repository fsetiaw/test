...
<body>
<div id="header">
	<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std5/subMenuStd5.jsp" />
</div>
...
if(atMenu!=null && atMenu.equalsIgnoreCase("std")) {
	%>
		<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std5/skl.jsp">
...
%>
		<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std5/isi_std/std_dosen.htm">
		<jsp:param name="target_kdpst" value="<%=target_kdpst %>"/>
		</jsp:include>
<%	
}
