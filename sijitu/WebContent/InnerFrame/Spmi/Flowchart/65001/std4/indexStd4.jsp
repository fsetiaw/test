...
<body>
<div id="header">
	<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std4/subMenuStd4.jsp" />
</div>
...
if(atMenu!=null && atMenu.equalsIgnoreCase("std")) {
	%>
		<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std4/skl.jsp">
...
%>
		<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std4/isi_std/std_penilaian.htm">
		<jsp:param name="target_kdpst" value="<%=target_kdpst %>"/>
		</jsp:include>
<%	
}
