...
<%
	...
	%>
	<li><a href="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/<%=target_kdpst %>/std1/indexStd1.jsp?atMenu=std&target_kdpst=<%=target_kdpst %>" target="inner_iframe" class="active">STANDAR KOMPETENSI<span>LULUSAN</span></a></li>
	<%
		}
		else {
	%>
	<li><a href="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/<%=target_kdpst %>/std1/indexStd1.jsp?atMenu=std&target_kdpst=<%=target_kdpst %>" target="inner_iframe">STANDAR KOMPETENSI<span>LULUSAN</span></a></li>
	<%		
		}
		if(atMenu!=null && atMenu.equalsIgnoreCase("isi")) {
	%>
	<li><a href="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/<%=target_kdpst %>/std1/indexStd1.jsp?atMenu=isi&target_kdpst=<%=target_kdpst %>" target="inner_iframe" class="active">PERNYATAAN ISI<span>STANDAR</span></a></li>
	<%
		}
		else {
	%>
	<li><a href="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/<%=target_kdpst %>/std1/indexStd1.jsp?atMenu=isi&target_kdpst=<%=target_kdpst %>" target="inner_iframe">PERNYATAAN ISI<span>STANDAR</span></a></li>
	<%		
		}
