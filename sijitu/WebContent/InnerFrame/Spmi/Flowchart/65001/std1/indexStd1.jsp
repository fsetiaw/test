...
<body>
<div id="header">
	<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std1/subMenuStd1.jsp" />
</div>
...
if(atMenu!=null && atMenu.equalsIgnoreCase("std")) {
	%>
		<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std1/skl.jsp">
...
%>
		<jsp:include page="${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/Flowchart/${prodi}/std1/isi_std/kompetensi_lulusan.jsp">
		<jsp:param name="target_kdpst" value="<%=target_kdpst %>"/>
		</jsp:include>
<%	
}
