...
%>
		<br> <br>
		<form action="go.updDokMutu" method="POST">
		<input type="hidden" name="kdpst_nmpst_kmp" value="<%=kdpst_nmpst_kmp%>"/>
		<input type="hidden" name="atMenu" value="list"/>
			...
			<thead>
				<tr>
					<th colspan="1" style="border-right:none;width:5%;color:#369;background-color:white;text-align: center; padding: 0px 10px;font-size:2em">&nbsp</th>
  					<th colspan="1" style="border-left:none;border-right:none;width:90%;color:#369;background-color:white;text-align: center; padding: 0px 10px;font-size:2em">EDIT JENIS DOKUMEN MUTU</th>
  				...
  				<tr>
  					<th colspan="3" style="text-align: left; padding: 0px 1px;font-size:1.7em"><%=prev_init_letter %></th>
  				</tr>
  			</thead>
  			<tbody>
  				<tr>
  					<td width="5%" align="right" style="border:none;vertical-align: middle; padding: 0px 1px">(<%=i++ %>)</td>
					<td colspan="2" width="95%" align="left" style="border:none;vertical-align: middle; padding: 0px 1px">
						<input type="hidden" name="nm_doc_mutu_ori" value="<%=nm_doc.toUpperCase() %>" style="width:100%;border:none"/>
						<input type="text" name="nm_doc_mutu_nu" value="<%=nm_doc.toUpperCase() %>" style="width:100%;border:none"/>
					</td>
				</tr>
  			</tbody>	
<%
	...
	%>
			<thead>
				<tr>
	  				<th colspan="3" style="text-align: left; padding: 0px 1px;font-size:1.7em"><%=curr_init_letter %></th>
	  			</tr>
	  		</thead>
	  		<%
		 	...
		 	<tr>
				<td colspan="3" style="padding:15px 0px">
						<section class="gradient" style="text-align:center">
	            			<button style="padding: 5px 50px;font-size: 20px;">UPDATE DOKUMEN MUTU</button>
        				</section>
				</td>		
			</tr>	
		 </table>
