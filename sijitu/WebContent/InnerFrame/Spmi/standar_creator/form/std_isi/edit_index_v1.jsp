...
<div id="header">
	...
	<ul>	
		...
		<li><a href="get.prepInfoStd?id_versi=<%=id_versi %>&id_std_isi=<%=id_std_isi %>&id_std=<%=id_std %>&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp %>&at_menu_dash=std&fwdto=dashboard_std_isi.jsp" target="_self" class="tile bg-darkOrange fg-white" data-role="tile">BACK<span><b style="color:#eee">---</b></span></a></li>
	</ul>
...
<%	
	...
	%>
			...
			<form action="ins.makeItStd_v1" method="post">
	...
	%>		
			...
			<input type="hidden" name="cakupan_std" value="<%=cakupan_std %>"/>
			
			<table class="table" width="90%">
				<thead>
					<tr>
	  					<th colspan="4" style="text-align: center; padding: 0px 10px;font-size:2.5em">EDIT FORM PARAMETER/INDIKATOR STANDAR</th>
	  				</tr>
	  				<!--  tr>
	  					<th width="5%">NO</th>
	  			...
	  			<tbody>	
					...
					<tr>
						<td colspan="4" align="center" style="vertical-align: middle; padding: 0px 0px;background:white;font-weight:bold;font-size:1.5em" >
							<Checker.pnn_v1(rasionale)  %>
						</td>
					</tr-->
					<tr>
						<td colspan="4" align="left" style="vertical-align: middle; padding: 0px 0px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.5em" >PERNYATAAN ISI STANDAR</td>
					</tr>
					<tr>
						<td colspan="4" align="center" style="vertical-align: middle; padding: 20px 20px;background:#E6E7E7;font-weight:bold;font-size:2em;text-align:center" >
							<input type="hidden" name="isi_std" value="<%=isi%>"/>
							<%=isi%>
						</td>
					</tr>		
					<tr>
						<td colspan="4" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.darkColorBlu()%>;color:white;font-weight:bold;font-size:2em;text-align:left" >LINGKUP CAKUPAN & KLASIFIKASI STANDAR MUTU</td>
					</tr>
					<tr>
					
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" title="Pilih Tingkat/Level Unit Satuan yg akan diukur" >
						LINGKUP CAKUPAN STANDARD
						</td>
						<td colspan="2" align="center" style="vertical-align: middle; padding: 0px 0px;background:#E6E7E7;font-weight:bold;font-size:1.25em;color:#000" >
						<%
						if(cakupan_std.equalsIgnoreCase("prodi")) {
							out.println("PROGRAM STUDI");
						}
						else if(cakupan_std.equalsIgnoreCase("univ")) {
							out.println("UNIVERSITAS");
						}	
						%>
						</td>
					</tr>
					<tr>
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;;font-weight:bold;font-size:1.25em" >RUMPUN STANDAR
						</td>
						<td colspan="2" align="center" style="vertical-align: middle; padding: 0px 0px;background:#E6E7E7;font-weight:bold;font-size:1.25em;color:#000" >
						...
						while(lir.hasNext()) {
							...
							if(id_root.equalsIgnoreCase(id_master)) {
								%>
							<input type="hidden" name="id_master" id="id_master" value="<%=id_root %>"/>
							<%=keter %>
							<%		
							}
							else {
					...
					%>
					<tr>
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >GOLONGAN STANDAR
						</td>
						<td colspan="2" align="center" style="vertical-align: middle; padding: 0px 0px;background:#E6E7E7;font-weight:bold;font-size:1.25em;color:#000" >
						...
						while(lir.hasNext()) {
							...
							if(id_tipe_std.equalsIgnoreCase(id_tipe_title)) {
								%>
							<input type="hidden" name="id_tipe" value="<%=id_tipe_std %>"/>
							<%=keter %>
							<%		
							}
							else {
					...
					%>
					<tr>
						<td colspan="4" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.darkColorBlu()%>;color:white;font-weight:bold;font-size:2em;text-align:left" >LAMA PERIODE PER PERIODE DAN SATUAN YG DIGUNAKAN SERTA PERIODE AWAL (I)</td>
					</tr>
					<tr>
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >SATUAN PERIODE
						</td>
						<td colspan="2" align="center" style="vertical-align: middle; padding: 0px 0px;background:white" >
						<select name="periode_unit_used" style="width:100%;height:35px;border:none;text-align-last:center;font-weight:bold;font-size:1.25em;background:#fff">
						<%
					...
					<tr>	
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >LAMA/PERIODE
						</td>
						<td colspan="2" align="center" style="vertical-align: middle; padding: 0px 0px;background:white" >
						<%
						if(!Checker.isStringNullOrEmpty(lama_per_period) && !lama_per_period.equalsIgnoreCase("0")) {
						%>
							<input  type="number" value="<%=lama_per_period %>" placeholder="1" name="qtt_unit_per_period" style="height:35px;text-align:center;width:100%;border:none;font-weight:bold;font-size:1.25em"  required />
						<%	
						}
						else {
						%>
							<input  type="number" placeholder="1" name="qtt_unit_per_period" style="height:35px;text-align:center;width:100%;border:none;font-weight:bold;font-size:1.25em" required/>
						<%
						}
						%>
						</td>
					...
					<tr>	
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >AWAL PERIODE [PERIODE I] 
						</td>
						<td colspan="2" align="center" style="vertical-align: middle; padding: 0px 0px;background:white" >
						<%
						if(!Checker.isStringNullOrEmpty(periode_awal)) {
							%>
							<input  type="text" placeholder="2016/20161" value="<%=periode_awal %>" name="periode_awal" style="height:35px;text-align:center;width:100%;border:none;font-weight:bold;font-size:1.25em" required/>
						<%	
						}
						else {
						%>
							<input  type="text" placeholder="2016/20161" name="periode_awal" style="height:35px;text-align:center;width:100%;border:none;font-weight:bold;font-size:1.25em" required/>
						<%	
						}
						%>
						</td>
					...
					<tr>
						<td colspan="4" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.darkColorBlu()%>;color:white;font-weight:bold;font-size:2em;text-align:left" >TARGET PER PERIODE DAN SATUAN SERTA INDIKATOR YG DIGUNAKAN</td>
					</tr>	
					<tr>	
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >PARAMETER YG DIUKUR
						</td>
						<td colspan="2" align="center" style="vertical-align: middle; padding: 0px 0px;background:white" >
						<%
						if(!Checker.isStringNullOrEmpty(tkn_param)) {
							%>
							<input  type="text" placeholder="isi nama parameter / variable" value="<%=tkn_param %>" name="tkn_variable" style="height:35px;text-align:center;width:100%;border:none;font-weight:bold;font-size:1.25em" required/>
						<%	
						}
						else {
						%>
							<input  type="text" placeholder="isi nama parameter / variable" name="tkn_variable" style="height:35px;text-align:center;width:100%;border:none;font-weight:bold;font-size:1.25em" required/>
						<%	
						}
						%>
					...
					<tr>	
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >INDIKATOR
						</td>
						<td colspan="2" align="center" style="vertical-align: middle; padding: 0px 0px;background:white" >
						<%
						if(!Checker.isStringNullOrEmpty(tkn_indikator)) {
							%>
							<input  type="text" placeholder="" value="<%=tkn_indikator %>" name="tkn_indikator" style="height:35px;text-align:center;width:100%;border:none;font-weight:bold;font-size:1.25em" required />
						<%	
						}
						else {
						%>
							<input  type="text" placeholder="" name="tkn_indikator" style="height:35px;text-align:center;width:100%;border:none;font-weight:bold;font-size:1.25em" required/>
						<%	
						}
						%>
					...
					<tr>
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >TARGET BESARAN PARAMETER PERIODE I</td>
						<td align="center" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >TARGET BESARAN PARAMETER PERIODE II</td>
						<td align="center" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >TARGET BESARAN PARAMETER PERIODE III</td>
					</tr>
					<tr>
						...
						if(!Checker.isStringNullOrEmpty(thsms1)) {
							%>
							<input type="number" step="0.01" name="target1" value="<%=thsms1 %>" style="height:35px;text-align:center;width:50%;border:none;font-weight:bold;font-size:1.25em" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target1" style="height:35px;text-align:center;width:50%;border:none;font-weight:bold;font-size:1.25em" required/>
						<%
						}
						%>
						[
							<input type="text" name="unit1" style="height:35px;text-align:center;border:none;font-weight:bold;font-size:1.25em" value="<%=Checker.pnn(target_unit1) %>" placeholder="isikan unit-satuan"/>
						<!--  	
						...
						<td align="center" style="vertical-align: middle; padding: 0px 0px;background:#E6E7E7" >
						<%
						if(!Checker.isStringNullOrEmpty(thsms2)) {
							%>
							<input type="number" step="0.01" name="target2" value="<%=thsms2 %>" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target2" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit2)) {
						%>
							[<input type="text" name="unit2" style="height:35px;text-align:center;width:20%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" value="<%=Checker.pnn(target_unit2) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
						...
						if(!Checker.isStringNullOrEmpty(thsms3)) {
							%>
							<input type="number" step="0.01" name="target3" value="<%=thsms3 %>" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target3" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit3)) {
						%>
							[<input type="text" name="unit3" style="height:35px;text-align:center;width:20%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" value="<%=Checker.pnn(target_unit3) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
					...
					<tr>
						<td align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >TARGET BESARAN PARAMETER PERIODE IV</td>
						<td align="center" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >TARGET BESARAN PARAMETER PERIODE V</td>
						<td align="center" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold;font-size:1.25em" >TARGET BESARAN PARAMETER PERIODE VI</td>
					</tr>
					<tr>
						<td align="center" style="vertical-align: middle; padding: 0px 0px;background:#E6E7E7" >
						<%
						if(!Checker.isStringNullOrEmpty(thsms4)) {
							%>
							<input type="number" step="0.01" name="target4" value="<%=thsms4 %>" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target4" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit4)) {
						%>
							[<input type="text" name="unit4" style="height:35px;text-align:center;width:20%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" value="<%=Checker.pnn(target_unit4) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
						...
						if(!Checker.isStringNullOrEmpty(thsms5)) {
							%>
							<input type="number" step="0.01" name="target5" value="<%=thsms5 %>" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target5" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit5)) {
						%>
							[<input type="text" name="unit5" style="height:35px;text-align:center;width:20%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" value="<%=Checker.pnn(target_unit5) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
						...
						if(!Checker.isStringNullOrEmpty(thsms6)) {
							%>
							<input type="number" step="0.01" name="target6" value="<%=thsms6 %>" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target6" style="height:35px;text-align:center;width:70%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit6)) {
						%>
							[<input type="text" name="unit6" style="height:35px;text-align:center;width:20%;border:none;font-weight:bold;font-size:1.25em;background:#E6E7E7" value="<%=Checker.pnn(target_unit6) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
					...
					<tr>
						<td colspan="4" style="padding:10px 0px">
							<section class="gradient" style="text-align:center">
		            			<button style="padding: 5px 50px;font-size: 30px;" value="std_usulan" name="tombol">UPDATE PARAMETER</button>
	        				</section>
						</td>		
					</tr>	
	  			</tbody>
