...
<div class="colmask fullpage">
	<div class="col1">
		...
		<table class="table" width="90%">
			<thead>
				<tr>
  					<th colspan="4" style="text-align: center; padding: 0px 10px;font-size:1.5em">FORM USULAN STANDARISASI</th>
  				</tr>
  				<!--  tr>
  					<th width="5%">NO</th>
  			...
  			<tbody>			
				<tr>
					<td colspan="4" align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold" >PIHAK TERKAIT</td>
				</tr>
				<tr>
					<td colspan="4" align="center" style="vertical-align: middle; padding: 0px 5px" >
...
<%
	...
	while(li.hasNext()) {
		...
		if(counter%3!=0) {
%>
								<td align="left" style="vertical-align: top;padding:0 20px"><input type="checkbox" name="job" value="<%=job %>" > <%=job %></td>
<%
		}
		else {
			%>
...
%>
				...
				<tr>
					<td colspan="4" align="left" style="vertical-align: middle; padding: 0px 5px;background: <%=Constant.mildColorBlu()%>;color:white;font-weight:bold" >GROUP JABATAN TERKAIT</td>
				</tr>
				<tr>
					<td colspan="4" align="center" style="vertical-align: middle; padding: 0px 5px" >
					<table class="table-noborder">	
...
<%
	...
	while(li.hasNext()) {
		...
		if(counter%3!=0) {
%>
								<td align="left" style="vertical-align: top;padding:0 20px"><input type="checkbox" name="grup_job" value="<%=job %>" > <%=job %></td>
<%
		}
		else {
			%>
...
%>
				...
				<!--  
				MASIh PENGAJUAN JADI DI HILANGKAN SAJA
				<tr>
				...
				<tr>
					<td colspan="4" align="center" style="vertical-align: bottom; padding: 0px 0px;background:white" >
