...
<%	
	...
	%>
			...
			<form action="ins.makeUnknownStd" method="post">
	...
	%>		
			...
			<input type="hidden" name="cakupan_std" value="prodi"/>
				...
				%>	
					...
					<tr>
						...
						if(!Checker.isStringNullOrEmpty(thsms1)) {
							%>
							<input type="number" step="0.01" name="target1" value="<%=thsms1 %>" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target1" style="height:25px;text-align:center;width:50%;border:none" required/>
						<%
						}
						%>
						[
							<input type="text" name="unit1" style="height:25px;text-align:center;width:50%;border:none" value="<%=Checker.pnn(target_unit1) %>" placeholder="isikan unit-satuan"/>
						<!--  	
						...
						if(!Checker.isStringNullOrEmpty(thsms2)) {
							%>
							<input type="number" step="0.01" name="target2" value="<%=thsms2 %>" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target2" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit2)) {
						%>
							[<input type="text" name="unit2" style="height:25px;text-align:center;width:20%;border:none" value="<%=Checker.pnn(target_unit2) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
						...
						if(!Checker.isStringNullOrEmpty(thsms3)) {
							%>
							<input type="number" step="0.01" name="target3" value="<%=thsms3 %>" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target3" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit3)) {
						%>
							[<input type="text" name="unit3" style="height:25px;text-align:center;width:20%;border:none" value="<%=Checker.pnn(target_unit3) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
					...
					<tr>
						...
						if(!Checker.isStringNullOrEmpty(thsms4)) {
							%>
							<input type="number" step="0.01" name="target4" value="<%=thsms4 %>" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target4" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit4)) {
						%>
							[<input type="text" name="unit4" style="height:25px;text-align:center;width:20%;border:none" value="<%=Checker.pnn(target_unit4) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
						...
						if(!Checker.isStringNullOrEmpty(thsms5)) {
							%>
							<input type="number" step="0.01" name="target5" value="<%=thsms5 %>" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target5" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit5)) {
						%>
							[<input type="text" name="unit5" style="height:25px;text-align:center;width:20%;border:none" value="<%=Checker.pnn(target_unit5) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
						...
						if(!Checker.isStringNullOrEmpty(thsms6)) {
							%>
							<input type="number" step="0.01" name="target6" value="<%=thsms6 %>" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%	
						}
						else {
						%>
							<input type="number" step="0.01" name="target6" style="height:25px;text-align:center;width:70%;border:none" required/>
						<%
						}
						if(!Checker.isStringNullOrEmpty(target_unit6)) {
						%>
							[<input type="text" name="unit6" style="height:25px;text-align:center;width:20%;border:none" value="<%=Checker.pnn(target_unit6) %>" readonly="readonly" />]
						<%
						}
						else {
							%>
