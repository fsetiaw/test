...
%>
<%="aneh" %>
<form id="updateHasilAmi" action="go.updateHasilAmi" method="get">
...
%>			
			...
			<input name="tombol" type=image border="0" alt="PLAY" src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/blue_left_arrow.png" width="50" height="50" style="text-decoration: none;" value="prev" />
<%
	}
%>			
			</td>
			<td style="width:40%;text-align:center;vertical-align:middle">
			<a href="#" class="img" onclick="document.getElementById('updateHasilAmi').submit();"><img src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/folder-doc-save.png" width="50" height="50" title="SAVE"><br>
			hal: <%=at_page%>/<%=tot_pg %>
			</a><br>
			</td>
			<td style="width:30%;text-align:center">
...
%>		
			...
			<input name="tombol" type=image border="0" alt="PLAY" src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/blue_right_arrow.png" width="50" height="50" style="text-decoration: none;" value="next" />
<%
	}
%>			
			</td>
...
%>
                  ...
                  <tr>
                     <td colspan="2" style="padding:0 0 0 10px;border:1px solid #1C79C6;border-right:none;border-bottom:none;background:<%=Constant.lightColorGrey() %>;font-weight:bold;color:black;text-align:left;vertical-align:top">Apakah terjadi pelanggaran</td>
                     <td style="border:1px solid #1C79C6;border-left:none;border-bottom:none;background:<%=Constant.lightColorGrey() %>;text-align:center">
                     	<select name="pelanggaran<%=counter %>" style="width:100%;height:35px;border:none;text-align-last:center">
<%
...
%>                     	                     		
                  ...
                  <tr>
                  		<td style="padding:0 10px 0 0;border:1px solid #1C79C6;border-right:none;border-top:none;background:<%=Constant.lightColorGrey() %>;font-weight:bold;color:black;text-align:right;vertical-align:top">Saran :</td>
                     <td colspan="2" style="border:1px solid #1C79C6;border-left:none;border-top:none;background:<%=Constant.lightColorGrey() %>;text-align:center"><textarea name="saran<%=counter %>" rows="" cols="" style="width:100%;border:none;height:70px"><%=Checker.pnn_v1(rekomendasi_hasil_ami) %></textarea></td>
                  </tr>
              </tbody>
           </table>
<%
