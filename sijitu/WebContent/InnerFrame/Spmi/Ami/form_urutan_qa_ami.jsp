...
//System.out.println("kdpst_nmpst_kmp22="+kdpst_nmpst_kmp);
...
Vector v = sa.previewAmiQandA(Integer.parseInt(id_master_std));
*/
...
<body>
<jsp:include page="menu_back_form_penilaian.jsp" />
