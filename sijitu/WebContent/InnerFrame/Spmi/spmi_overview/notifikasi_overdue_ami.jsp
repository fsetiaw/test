...
ListIterator li = v_kegiatan_ami_yg_lewat.listIterator();
...
<%
	...
	while(li.hasNext()) {
		...
		String tgl_rencana = st.nextToken();;
		String ketua_tim = st.nextToken();;
		String anggota_tim = st.nextToken();;
		String cakupan_std = st.nextToken();;
		
		String keter = "[KEGIATAN AUDIT MUTU INTERNAL "+Converter.getNamaKdpst(kdpst)+"]";
		keter=keter+"<br>Tanggal Rencana Kegiatan: "+Converter.autoConvertDateFormat(tgl_rencana, "/");
%>
			...
			<tbody>
				...
				<tr>
					...
					if(!Checker.isStringNullOrEmpty(ketua_tim)) {
						StringTokenizer stt = new StringTokenizer(ketua_tim,",");
						int j=1;
						while(stt.hasMoreTokens()) {
							out.println(j+++". "+stt.nextToken().toUpperCase());
				...
				<tr>
					...
					if(!Checker.isStringNullOrEmpty(anggota_tim)) {
						StringTokenizer stt = new StringTokenizer(anggota_tim,",");
						int j=1;
						while(stt.hasMoreTokens()) {
							out.println(j+++". "+stt.nextToken().toUpperCase());
							if(stt.hasMoreTokens()) {
...
%>					
					...
					if(!Checker.isStringNullOrEmpty(cakupan_std)) {
						StringTokenizer stt = new StringTokenizer(cakupan_std,",");
						int j=1;
						while(stt.hasMoreTokens()) {
							out.println(j+++". "+stt.nextToken().toUpperCase());
							if(stt.hasMoreTokens()) {
