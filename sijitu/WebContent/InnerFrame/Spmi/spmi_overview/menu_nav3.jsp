...
location.href='go.prepDashOverviewSpmi?fwdto=overview&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp%>'})()" target="inner_iframe" >
...
x.style.display = 'block';
y.style.display = 'none';
location.href='go.prepDashOverviewSpmi?fwdto=dokumen&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp%>'})()" target="inner_iframe" >
        	    		<img src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/refresh_ico.png" width="35px" height="35px" >
            	  		<p class="no-margin text-shadow" style="font-weight:bold;font-size:1.em;color:black">REFRESH</p>
					</a>
				</td>
			</tr>
		</table>