...
<%
	if(ToolMhs.isStringNullOrEmpty(from)) {
%>				
			...
			location.href='go.prepDashOverviewSpmi?fwdto=never_mon&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp%>'})()" target="inner_iframe" >
...
%>				
		...
		x.style.display = 'block';
		y.style.display = 'none';
		location.href='go.prepDashOverviewSpmi?fwdto=pelanggaran&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp%>'})()" target="inner_iframe" >
				<img src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/go_back.png" width="35px" height="35px" >
    			<p class="no-margin text-shadow" style="font-weight:bold;font-size:1.em;color:black">BACK</p>
			</a>
<%	
