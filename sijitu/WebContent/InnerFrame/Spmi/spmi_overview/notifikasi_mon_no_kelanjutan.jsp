...
Vector v_kegiatan_monitoring_no_pengendalian=(Vector)request.getAttribute("v_kegiatan_monitoring_no_kelanjutan");
...
<%
	...
	while(li.hasNext()) {
		...
		keter=keter+"<br>Tanggal Monitoring Terakhir: "+Converter.autoConvertDateFormat(tgl_eval, "/");
		keter=keter+"<br>Tanggal Rencana Monitoring Selanjutnya: "+Converter.autoConvertDateFormat(tgl_next_eval, "/");
%>
