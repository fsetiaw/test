...
//System.out.println("form_tgl_sta="+form_tgl_sta);
String form_waktu_sta = request.getParameter("waktu_sta");
//System.out.println("form_waktu_sta="+form_waktu_sta);
...
//System.out.println("form_nmm_kegiatan="+form_nmm_kegiatan);
String form_tujuan_kegiatan = request.getParameter("tujuan_kegiatan");
//System.out.println("form_tujuan_kegiatan="+form_tujuan_kegiatan);
String form_isi_kegiatan = request.getParameter("isi_kegiatan");
//System.out.println("form_isi_kegiatan="+form_isi_kegiatan);
String[] form_job_jawab = request.getParameterValues("job_jawab");
//System.out.println("form_job_jawab="+form_job_jawab);
String[] form_job_target = request.getParameterValues("job_target");
//System.out.println("form_job_target="+form_job_target);
String[] form_dok_mutu = request.getParameterValues("dok_mutu");
//System.out.println("form_dok_mutu="+form_dok_mutu);
String form_started = request.getParameter("started");
//System.out.println("form_jenis_kegiatan="+form_jenis_kegiatan);
//System.out.println("form_started="+form_started);
...
//Vector v = sm.prepInfoFormPengendalian(Integer.parseInt(id_versi), Integer.parseInt(id_std_isi), Integer.parseInt(norut_man));
			...
			<tr>
				...
				<td style="width:70%;background:#D7D7D7;color:#369;font-size:0.8em;text-align:center;padding:0 0 0 0">
					<select name="jenis_kegiatan" style="height:30px;width:100%;border:none;text-align-last:center;border-radius: 0px;">
						<option value="kendali_std" selected="selected">Pengendalian Pelaksanaan Standar</option>
					</select>	
				</td>
			</tr>
			<tr>
