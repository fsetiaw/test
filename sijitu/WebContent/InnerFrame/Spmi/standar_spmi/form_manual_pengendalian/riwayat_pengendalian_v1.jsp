...
String kegiatan = "";
String ppepp = "pengendalian";

String tgl_sta_man = ""+ts.getTglStartManualUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std), "pengendalian");
...
<body>
<jsp:include page="menu_man_kendal_v1.jsp" />
...
v_hist_plan=shk.getListRiwayatPengendalianUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std),offset,Integer.parseInt(src_manual_limit)-1);
...
%>	
	...
	if((team_spmi||editor)&&!man_expired) {	
		...
		%>
					...
					TAMBAH KEGIATAN PENGENDALIAN PELAKSANAAN STANDAR
		<%
		}
		else {
			%>
		...
		<tr>
			<td style="text-align:center;font-size:1.3em;font-weight:bold" align="center">
				<input type="image" src="<%=Constants.getRootWeb() %>/images/add_ico.png" width="35" height="35" alt="Submit Form" onclick="this.form.submit()" />
				TAMBAH KEGIATAN PENGENDALIAN PELAKSANAAN STANDAR<br>[Anda tidak memiliki akses untuk menambah kegiatan]
			</td>
		</tr>			
		<%
		}
...
%>
<form action="go.updRiwayatPengendalian_v1" method="post">
	<input type="hidden" name="status_manual" value="<%=status_manual %>" />
	<input type="hidden" name="target_unit_used" value="<%=target_unit_used %>" />
	<input type="hidden" name="kdpst_nmpst_kmp" value="<%=kdpst_nmpst_kmp %>" />
	<input type="hidden" name="id_versi" value="<%=id_versi %>" />
	...
	<table class="StateTable" rules="all" cellpadding="0" cellspacing="0" style="border:1px solid #369;width:100%;background:white;">
		<thead>
			<%
...
%>				
<form action="go.updRiwayatHasilPengendalian_v1" method="post">
	<input type="hidden" name="status_manual" value="<%=status_manual %>" />
	<input type="hidden" name="target_unit_used" value="<%=target_unit_used %>" />
	<input type="hidden" name="kdpst_nmpst_kmp" value="<%=kdpst_nmpst_kmp %>" />
	<input type="hidden" name="id_versi" value="<%=id_versi %>" />
