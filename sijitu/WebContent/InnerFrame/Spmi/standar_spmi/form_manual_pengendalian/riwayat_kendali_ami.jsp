...
v_hist_eval=shk.getListRiwayatPengendalianAmi(Integer.parseInt(id_versi), Integer.parseInt(id_std_isi), Integer.parseInt(norut_man),offset,Integer.parseInt(src_manual_limit),kdpst);
				...
				if(!Checker.isStringNullOrEmpty(target_unit_used)) {
					out.print(target_unit_used);
						...
						<tr>
							...
							<td style="border:1px solid #369;vertical-align:middle;text-align:center;font-size:1.5em;font-weight:bold"><%=target_val_eval %></td>
							<td style="border:1px solid #369;vertical-align:middle;text-align:center;font-size:1.5em;font-weight:bold"><%=real_val_eval %></td>
						</tr>
					</table>
				</td>
			</tr>
			...
			%>
							<tr>
								...
								<th colspan="1" style="border: 1px solid #FE9A2E;vertical-align:middle;text-align:center;background:#FE9A2E;color:#369;padding:0 0 0 0;font-size:2em;font-weight:bold">
									FORM PENGENDALIAN KEGIATAN AMI 
