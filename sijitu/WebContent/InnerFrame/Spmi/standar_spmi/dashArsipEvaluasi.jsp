...
<%
	...
	if(!Checker.isStringNullOrEmpty(id_versi)) {
		ts.createFolderStructureStandarUmum(id_versi,"evaluasi");
		//File[] listFileFolder = (File[])session.getAttribute("listFileFolder");
		v_nm_alm_access = new Vector();
		li = v_nm_alm_access.listIterator();
		li.add("Folder Utama`"+ts.getRootStandarSpmiFolder(id_versi,"evaluasi")+"`reid");
		
		ts.createFolderRiwayatKegiatanUmum(id_versi, "evaluasi");
