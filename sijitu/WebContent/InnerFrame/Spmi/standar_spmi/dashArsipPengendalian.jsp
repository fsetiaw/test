...
<%
	...
	if(!Checker.isStringNullOrEmpty(id_versi)) {
		ts.createFolderStructureStandarUmum(id_versi,"pengendalian");
		//File[] listFileFolder = (File[])session.getAttribute("listFileFolder");
		v_nm_alm_access = new Vector();
		li = v_nm_alm_access.listIterator();
		li.add("Folder Utama`"+ts.getRootStandarSpmiFolder(id_versi,"pengendalian")+"`reid");
		
		ts.createFolderRiwayatKegiatanUmum(id_versi, "pengendalian");
	...
	//ts.createFolderStructureManualUmum(id_versi,"pengendalian");
	
	//ts.createFolderRiwayatKegiatanUmum(id_std, "pengendalian");
