...
if(!Checker.isStringNullOrEmpty(id_std_isi)&&!Checker.isStringNullOrEmpty(id_versi)) {
	norut_terakhir = ts.getNorutTerakhirManPerencanaanStd(Integer.parseInt(id_std_isi), Integer.parseInt(id_versi));
}
...
<%
	...
	String brs = sm.searchListManualPerencanaan(Integer.parseInt(id_versi), Integer.parseInt(id_std_isi), Integer.parseInt(norut_man));
			...
			<thead>
				<tr>
					<th colspan="2" style="font-size:2em;text-align:center;font-weight:bold;">
						FORM INPUT MANUAL PERENCANAAN STANDAR
					</th>
				</tr>
				<tr>
