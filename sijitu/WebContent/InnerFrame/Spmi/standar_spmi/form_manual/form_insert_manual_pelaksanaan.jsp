...
if(!Checker.isStringNullOrEmpty(id_std_isi)&&!Checker.isStringNullOrEmpty(id_versi)) {
	norut_terakhir = ts.getNorutTerakhirManPelaksanaanStd(Integer.parseInt(id_std_isi), Integer.parseInt(id_versi));
}
...
%>		
	<center>
	<form action="go.updManualPelaksanaan" method="post">
...
<%
	...
	String brs = sm.searchListManualPelaksanaan(Integer.parseInt(id_versi), Integer.parseInt(id_std_isi), Integer.parseInt(norut_man));
