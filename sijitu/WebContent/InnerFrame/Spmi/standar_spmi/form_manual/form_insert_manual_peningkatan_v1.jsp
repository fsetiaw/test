...
norut_terakhir = ts.getNorutTerakhirManPeningkatanStdUmum(Integer.parseInt(id_std));
...
%>		
	<center>
	<form action="go.updManualPeningkatan_v1" method="post">
...
<%
	...
	String brs = sm.searchListManualPeningkatanUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std));
