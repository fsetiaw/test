...
norut_terakhir = ts.getNorutTerakhirManEvaluasiPelaksanaanStdUmum(Integer.parseInt(id_std));
...
%>		
	<center>
	<form action="go.updManualEvaluasi_v1" method="post">
...
<%
	...
	String brs = sm.searchListManualEvaluasiUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std));
			...
			<thead>
				<tr>
					<th colspan="2" style="font-size:2em;text-align:center;font-weight:bold;">
						FORM INPUT MANUAL EVALUASI PELAKSANAAN
					</th>
				</tr>
				<tr>
...
%>						
						<textarea name="definisi" placeholder="hanya diisi definisi kata yang bersifat teknis, bila tidak ada isikan 'Tidak ada istilah teknis yang digunakan dalam penetapan standar'" style="width:100%;height:100px;row:5;border:none"></textarea>
<%
}
else {
	%>						
