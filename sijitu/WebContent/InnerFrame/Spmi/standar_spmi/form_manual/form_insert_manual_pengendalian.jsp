...
%>		
	...
	<form action="go.updManualStd" method="post">
		...
		<table class="table1" id="tabel" style="width:90%" >
			...
			<thead>
				<tr>
					<td style="font-size:2em;text-align:center;font-weight:bold;color:#369">
					INPUT FORM MANUAL PENGENDALIAN
					</td>
				</tr>
				<tr>
					...
					%> 
					<input type="number" name="norut" placeholder="1" required style="text-align:center;width:50px;height:20px;border:none"/>
					<%
					}
					else {
						%> 
					<input type="number" name="norut" placeholder="1" value="<%=norut %>" required style="text-align:center;width:50px;height:20px;border:none"/>
						<%
					}
					%> 
			...
			<tbody>
				<tr>
					<td colspan="10" style="vertical-align:top;text-align:center;padding:10px 0;font-size:1.3em;background:white">
					<textarea name="isi_std" style="width:100%;height:100px;border:none;rows:5" placeholder="Berikan keterangan mengenai parameter/objek beserta proses yg hendak dikendalikan&#13;&#10;[contoh: Kelas perkuliahan wajib dimulai tepat waktu]" required><%=Checker.pnn(ket_proses) %></textarea>	
					</td>
				</tr>
			</tbody>
			<tr>
					<th colspan="10" style="border-left: none;text-align:left;height:30px;vertical-align:middle;padding:0 5px;width:95%;border:none;font-size:1.0em;font-weight:bold">
					PROSES / OBJEK / PARAMETER YG DIKENDALIKAN
					</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td colspan="10" style="vertical-align:top;text-align:center;padding:10px 0;font-size:1.3em;background:white">
					<textarea name="ket_proses" style="width:100%;height:100px;border:none;rows:5" placeholder="Berikan keterangan mengenai parameter/objek beserta proses yg hendak dikendalikan&#13;&#10;[contoh: Kelas perkuliahan wajib dimulai tepat waktu]" required><%=Checker.pnn(ket_proses) %></textarea>	
					</td>
				</tr>
			</tbody>
			<thead>
			...
			<tbody>
				<tr>
					<td colspan="10" style="text-align:center;padding:10px 0;font-size:1.3em;background:white">
					<textarea name="capaian" style="width:100%;height:100px;border:none;rows:5" placeholder="[contoh: Kelas perkuliahan dimulai tepat waktu sesuai pernyataan isi std]" required><%=Checker.pnn(capaian) %></textarea>	
					</td>
				</tr>
			</tbody>
			<thead>	  			
...
%>
			...
			<thead>
				<tr>
					<th colspan="10" style="border-left: none;text-align:left;height:30px;vertical-align:middle;padding:0 5px;width:95%;border:none;font-size:1.0em;font-weight:bold">
					MANUAL / PROSEDUR PROSES PENGAWASAN
					</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					...
					%>
					<td colspan="10" style="text-align:center;padding:10px 0;font-size:1.3em;background:white">
					<textarea name="manual" style="width:100%;height:150px;border:none;rows:9" placeholder="<%=tmp %>" required><%=Checker.pnn(manual) %></textarea>	
					</td>
				</tr>
			</tbody>
			<thead>
...
if(!Checker.isStringNullOrEmpty(tipe_sarpras) && tipe_sarpras.equalsIgnoreCase("umum")) {
	%>
								...
								<input type="radio" name="tipe_sarpras" value="umum" checked="checked"> Catat sbg Bentuk Dasar [contoh: Kelas Kuliah]<br>
								<input type="radio" name="tipe_sarpras" value="detil"> Catat sbg Bentuk Detil [Contoh: Kode Ruang Kelas]
	<%	
}
							...
							%>
								<input type="radio" name="tipe_sarpras" value="none"> Tidak Diperlukan<br>
  								...
  								<input type="radio" name="tipe_sarpras" value="detil" checked="checked"> Catat sbg Bentuk Detil [Contoh: Kode Ruang Kelas]
  							<%
}
...
if(!Checker.isStringNullOrEmpty(catat_civitas) && catat_civitas.equalsIgnoreCase("1")) {
			...
			<thead>	  			
				<tr>
					<th colspan="10" style="border-left: none;text-align:left;height:30px;vertical-align:middle;padding:0 5px;width:95%;border:none;font-size:1.0em;font-weight:bold">
					PILIH 1 (SATU) PIHAK [JABATAN/GROUP] SEBAGAI PENGINPUT DATA SURVEY LAPANGAN
					</th>
				</tr>
				<tr>
					<th colspan="10" style="background:#a6bac4;border-left: none;text-align:left;height:30px;vertical-align:middle;padding:0 5px;width:95%;border:none;font-size:1.0em;font-weight:bold">
