...
norut_terakhir = ts.getNorutTerakhirManPerencanaanStdUmum(Integer.parseInt(id_std));
...
%>		
	<center>
	<form action="go.updManualPerencanaan_v1" method="post">
...
<%
	...
	String brs = sm.searchListManualPerencanaanUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std));
...
%>						
				...
				<tr>
					<td style="vertical-align:top;padding:0 5px 0 5px;width:20%;font-size:1.em;text-align:left;font-weight:bold;color:#369">
						DOKUMEN TERKAIT
