...
<div id="header">
	<ul>
	<li><a href="get.prepInfoStd?id_versi=<%=id_versi %>&id_std_isi=<%=id_std_isi %>&id_std=<%=id_std %>&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp %>&at_menu_dash=<%= at_menu_dash%>&fwdto=<%=fwdto%>&darimana=riwayat">BACK <span><b style="color:#eee">&nbsp</b></span></a></li>
	</ul>
</div>
