...
norut_terakhir = ts.getNorutTerakhirManPengendalianPelaksanaanStdUmum(Integer.parseInt(id_std));
...
%>		
	<center>
	<form action="go.updManualPengendalian_v1" method="post">
...
<%
	...
	//edit yg ada
	String brs = sm.searchListManualPengendalianUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std));
			...
			<thead>
				<tr>
					<th colspan="2" style="font-size:2em;text-align:center;font-weight:bold;">
						FORM INPUT MANUAL PENGENDALIAN PELAKSANAAN
					</th>
				</tr>
				<tr>
