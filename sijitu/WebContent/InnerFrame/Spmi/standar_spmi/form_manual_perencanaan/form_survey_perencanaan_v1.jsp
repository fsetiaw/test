...
boolean man_sdh_ditetapkan=false;
String tgl_tmp = ts.getPenetapanTanggalManualUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std), "penetapan","perencanaan");
...
try {
	java.sql.Date.valueOf(tgl_tmp);
	man_sdh_ditetapkan=true;
}
catch(Exception e) {}
//System.out.println("man_sdh_ditetapkan="+man_sdh_ditetapkan);
