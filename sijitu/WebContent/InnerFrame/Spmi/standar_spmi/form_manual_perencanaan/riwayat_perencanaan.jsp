...
String tgl_sta_man = ""+ts.getTglStartManual(Integer.parseInt(id_versi), Integer.parseInt(id_std_isi), Integer.parseInt(norut_man), "perencanaan");
...
<body>
<jsp:include page="menu_man_perencanaan.jsp" />
...
v_hist_plan=shk.getListRiwayatPerencanaan(Integer.parseInt(id_versi), Integer.parseInt(id_std_isi), Integer.parseInt(norut_man),offset,Integer.parseInt(src_manual_limit)-1);
...
%>	
		...
		<tr>
			<td colspan="7" style="text-align:center;padding:0 0;font-size:2.0em;font-weight:bold">
				Belum Ada Riwayat Kegiatan Perencanaan						
			</td>
		</tr>
		<%
	...
	//if(editor) {
		...
		<tr>
			<td style="text-align:center;font-size:1.3em;font-weight:bold" align="center">
				...
				<form action="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/standar_spmi/form_manual_perencanaan/form_survey_perencanaan.jsp">
		...
		if(!man_sdh_aktif) {
		%>
					TAMBAH KEGIATAN PERANCANGAN MANUAL
		<%
		}
		else {
			%>
					TAMBAH KEGIATAN PERENCANAAN STANDAR
		<%	
		}
		%>			
				</form>
...
%>
	...
	if(!Checker.isStringNullOrEmpty(tgl_tetap_man) && Checker.isStringNullOrEmpty(tgl_sta_man)) {
		...
		<section style="align:center;text-align:center;font-weight:bold;color:red">	
			...
			<input type="image" src="<%=Constants.getRootWeb() %>/images/add_ico.png" width="35" height="35" alt="Submit Form" />TAMBAH KEGIATAN PERENCANAAN STANDAR
			<br>
		...
		<section style="align:center;text-align:center">	
			<p>
				<form action="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/Spmi/standar_spmi/form_manual_perencanaan/form_survey_perencanaan.jsp" style="font-weight:bold;color:#369">
					<input type="hidden" name="status_manual" value="<%=status_manual %>" />
					<input type="hidden" name="scope_std" value="<%=scope_std %>" />
					<input type="hidden" name="std_kdpst" value="<%=std_kdpst %>" />
					<input type="hidden" name="id_versi" value="<%=id_versi %>" />
...
<table align="center" style="width:100%">
	<tr>
		<td colspan="8" style="font-size:2em;text-align:center;font-weight:bold;color:#369">
			RIWAYAT PERENCANAAN MANUAL & STANDAR
		</td>
	</tr>
...
<%	
	...
	if(li.hasNext()) {
		...
		while(li.hasNext()&& (no_yg_tampil <= max_yg_tampil)) {
			...
			String std_isi_id_hist=st.nextToken();
			String norut_man_hist=st.nextToken();
...
%>
<form action="go.updRiwayatPerencanaan" method="post">
	<input type="hidden" name="status_manual" value="<%=status_manual %>" />
	<input type="hidden" name="target_unit_used" value="<%=target_unit_used %>" />
	<input type="hidden" name="kdpst_nmpst_kmp" value="<%=kdpst_nmpst_kmp %>" />
	<input type="hidden" name="id_versi" value="<%=id_versi %>" />
	...
	<table class="StateTable" rules="all" cellpadding="0" cellspacing="0" style="border:none;width:100%;background:white;">
		...
		<tr class="statetablerow">
			...
			<tr class="statetablerow">
				<td colspan="3" style="background:#369;vertical-align:middle;font-size:2em;text-align:center;font-weight:bold;color:#fff">
					<img src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/up_down_white.png" alt="Smiley face" height="42" width="42" style="vertical-align:middle">&nbsp&nbsp&nbsp&nbsp<%=counter++%>.  INFORMASI KEGIATAN / RENCANA KEGIATAN <%=ToolSpmi.cetakJenisKegiatanManualDanStandar(jenis_kegiatan_hist)%>&nbsp&nbsp&nbsp&nbsp<img src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/up_down_white.png" alt="Smiley face" height="42" width="42" style="vertical-align:middle">
				</td>
			</tr>
			<tr>
		...
		<tbody>	
			...
			<tr>
				...
				if(!Checker.isStringNullOrEmpty(nama_kegiatan_hist)) {
					%>
					<textarea name="tujuan_kegiatan" minlength="15" style="vertical-align:middle;width:100%;height:100px;border:none;rows:3" placeholder="isikan keterangan singkat capaian/tujuan kegiatan" required><%=tujuan_kegiatan_hist %></textarea>
				<%
				}
				else {
				%>
			...
			<tr>
				...
				if(!Checker.isStringNullOrEmpty(nama_kegiatan_hist)) {
					%>
					<textarea name="isi_kegiatan" minlength="15" style="vertical-align:middle;width:100%;height:100px;border:none;rows:3" placeholder="isikan keterangan singkat capaian/tujuan kegiatan" required><%=isi_kegiatan_hist %></textarea>
				<%
				}
				else {
				%>
...
%>				
<form action="go.updRiwayatHasilPerencanaan" method="post">
	<input type="hidden" name="status_manual" value="<%=status_manual %>" />
	<input type="hidden" name="target_unit_used" value="<%=target_unit_used %>" />
	<input type="hidden" name="kdpst_nmpst_kmp" value="<%=kdpst_nmpst_kmp %>" />
	<input type="hidden" name="id_versi" value="<%=id_versi %>" />
	...
	<table class="StateTable" rules="all" cellpadding="0" cellspacing="0" style="border:none;width:100%;background:white;">
		<thead>
			<tr class="statetablerow">
				...
				<td colspan="3" style="background:#369;vertical-align:middle;font-size:2em;text-align:center;font-weight:bold;color:#fff">
					<img src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/up_down_white.png" alt="Smiley face" height="42" width="42" style="vertical-align:middle">&nbsp&nbsp&nbsp&nbsp<%=counter++%>.  INFORMASI KEGIATAN <%=ToolSpmi.cetakJenisKegiatanManualDanStandar(jenis_kegiatan_hist)%>&nbsp&nbsp&nbsp&nbsp<img src="<%=Constants.getRootWeb() %>/Metro-UI-CSS-master/docs/images/up_down_white.png" alt="Smiley face" height="42" width="42" style="vertical-align:middle">
				</td>
		...
		<tbody>	
			...
			<tr>
				...
				out.print(tujuan_kegiatan_hist); 
				%>
				</td>
			</tr>
			<tr>
...
%>
			...
			%>
				...
				%>	
												<textarea name="hasil" minlength="15" style="vertical-align:middle;width:100%;height:100px;border:none;rows:5" placeholder="isikan hasil dari kegiatan" required><%=hasil_kegiatan_hist %></textarea>
				<%
				}
				%>							
											</td>
				...
				%>	
												<textarea name="note"  style="vertical-align:middle;width:100%;height:100px;border:none;rows:5" placeholder="catatan tambahan kegiatan (optional)"><%=note_kegiatan_hist %></textarea>
				<%
				}
				%>
											</td>
