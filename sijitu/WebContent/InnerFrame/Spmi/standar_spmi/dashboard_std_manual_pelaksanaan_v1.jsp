...
//System.out.println("id_std="+id_tipe_std);
...
//smm.autoInsertManual(Integer.parseInt(id_versi),Integer.parseInt(id_std_isi), "pelaksanaan");
%>
<style>
a.img:hover {
...
$(document).ready(function() {
	...
	document.getElementById('kendali').style.display='none';
});	
</script>
...
if(!Checker.isStringNullOrEmpty(darimana)&&darimana.equalsIgnoreCase("riwayat")) {
	//System.out.println("kesinsikan1");
	%>
	
<body onload="window.resizeTo(screen.width, 4500);document.getElementById('chart').style.display='none';document.getElementById('form1').style.display='block';document.links[7].className = 'active';document.links[6].className = '';document.links[8].className = '';document.getElementById('upload').style.display='none';document.getElementById('ami').style.display='none';document.links[9].className = '';document.getElementById('kendali').style.display='none';document.links[10].className = '';">
<%
}
else if(!Checker.isStringNullOrEmpty(darimana)&&darimana.equalsIgnoreCase("ami")) {
	//System.out.println("kesinsikan2");
	%>
<body onload="window.resizeTo(screen.width, 4500);document.getElementById('chart').style.display='none';document.getElementById('form1').style.display='none';document.getElementById('upload').style.display='none';document.getElementById('ami').style.display='block';document.links[9].className = 'active';document.links[7].className = '';document.links[6].className = '';document.links[8].className = '';document.getElementById('kendali').style.display='none';document.links[10].className = '';">
<%	
}
else if(!Checker.isStringNullOrEmpty(darimana)&&darimana.equalsIgnoreCase("ami2")) {
	//System.out.println("kesinsikan3");
	%>
<body onload="window.resizeTo(screen.width, 4500);document.getElementById('chart').style.display='none';document.getElementById('form1').style.display='none';document.getElementById('upload').style.display='none';document.getElementById('ami').style.display='none';document.links[9].className = '';document.links[7].className = '';document.links[6].className = '';document.links[8].className = '';document.getElementById('kendali').style.display='block';document.links[10].className = 'active';">
<%	
}
else {
//System.out.println("kesinsikan4");
%>
...
<div id="header">
<ul>
	<li><a href="#form" onclick="document.getElementById('chart').style.display='block';document.links[6].className = 'active';document.getElementById('form1').style.display='none';document.links[7].className = '';document.getElementById('upload').style.display='none';document.links[8].className = '';document.getElementById('ami').style.display='none';document.links[9].className = '';document.getElementById('kendali').style.display='none';document.links[10].className = '';" >MANUAL PELAKSANAAN<br>STANDAR</a></li>
	<li><a href="#form" onclick="document.getElementById('chart').style.display='none';document.links[6].className = '';document.getElementById('form1').style.display='block';document.links[7].className = 'active';document.getElementById('upload').style.display='none';document.links[8].className = '';document.getElementById('ami').style.display='none';document.links[9].className = '';document.getElementById('kendali').style.display='none';document.links[10].className = '';" >KEGIATAN MANUAL<br>PELAKSANAAN STANDAR</a></li>
	<li><a href="#form" onclick="document.getElementById('glue').contentWindow.location.reload();document.getElementById('chart').style.display='none';document.links[6].className = '';document.getElementById('form1').style.display='none';document.links[7].className = '';document.getElementById('upload').style.display='block';document.links[8].className = 'active';document.getElementById('ami').style.display='none';document.links[9].className = '';document.getElementById('kendali').style.display='none';document.links[10].className = '';" >ARSIP FILE<br>DOKUMEN</a></li>
	<li><a href="#form" onclick="document.getElementById('chart').style.display='none';document.getElementById('form1').style.display='none';document.getElementById('upload').style.display='none';document.getElementById('ami').style.display='block';document.getElementById('kendali').style.display='none';document.links[9].className = 'active';document.links[7].className = '';document.links[6].className = '';document.links[8].className = '';document.links[10].className = '';" >KEGIATAN MONITORING<br>PELAKSANAAN STANDAR</a></li>
	<li><a href="#form" onclick="document.getElementById('chart').style.display='none';document.getElementById('form1').style.display='none';document.getElementById('upload').style.display='none';document.getElementById('ami').style.display='none';document.getElementById('kendali').style.display='block';document.links[9].className = '';document.links[7].className = '';document.links[6].className = '';document.links[8].className = '';document.links[10].className = 'active';" >KEGIATAN PENGENDALIAN<br>HASIL MONITORING</a></li>
</ul>
...
Vector v_kendal= sm.searchListManualPelaksanaanUmum(Integer.parseInt(id_std));
//Vector v_kendal= sm.searchListManualPelaksanaan(Integer.parseInt(id_versi), Integer.parseInt(id_std_isi));
//Vector v_best_manual_kendal = sm.getManualPelaksanaanAktifAtoLatestDraft(Integer.parseInt(id_versi), Integer.parseInt(id_std_isi));
if(!editor) {	
%>
...
%>
	<thead>	
		...
		<tr>
			...
			PROSEDUR DAN LANGKAH PELAKSANAAN STANDAR
			</th>
...
<%
	...
	while(li.hasNext()) {
		...
		boolean man_expired = ts.apaManualSudahExpiredUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std), "PELAKSANAAN");
		/*
...
<%		
		...
		if(false) {
%>
			<form action="<%=Constants.getRootWeb() %>/InnerFrame/Spmi/standar_spmi/form_manual/form_insert_manual_pelaksanaan_v1.jsp" method="post">
				...
				<input type="hidden" name="fwdto" value="dashboard_std_manual_pelaksanaan_v1.jsp"/>
...
%>									
			...
			<td onclick="window.location.href='<%=Constants.getRootWeb() %>/InnerFrame/Spmi/standar_spmi/form_manual_pelaksanaan/riwayat_pelaksanaan_v1.jsp?status_manual=<%=status_manual%>&starting_no=1&unit_used=<%=unit_used %>&scope_std=<%=scope_std%>&std_kdpst=<%=std_kdpst %>&id_versi=<%=id_versi %>&id_tipe_std=<%=id_tipe_std %>&id_master_std=<%=id_master_std %>&id_std=<%=id_std %>&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp %>&at_menu_kendal=riwayat&at_menu_dash=do'" style="text-align:left;padding:0 2px;font-size:0.9em;padding:0 0 0 5px">
				<%=prosedur %>						
			</td>
			<td style="text-align:center;padding:0 2px;font-size:0.9em">
				...
				if(status_manual.equalsIgnoreCase("AKTIF")) {
					%>
				<a class="img2" href="set.aktivasiMan_v1?status=aktif&tipe_manual=pelaksanaan&id_versi=<%=id_versi %>&id_tipe_std=<%=id_tipe_std %>&id_master_std=<%=id_master_std %>&id_std=<%=id_std %>&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp%>&at_menu_dash=<%= at_menu_dash%>&fwdto=dashboard_std_manual_pelaksanaan_v1.jsp" style="text-decoration: none;" onclick="if (confirm('Apakah anda yakin akan memberhentikan penggunaan manual ini ?!? \nNote:\n1. Anda tidak dapat mengaktifkan kembali manual yg sudah diberhentikan.\n2. Pemberhentian manual dilakukan bila manual digantikan dengan revisi yg baru')) return true; ">
					...
					%>
				<a class="img2" href="set.aktivasiMan_v1?status=nonaktif&tipe_manual=pelaksanaan&id_versi=<%=id_versi %>&id_tipe_std=<%=id_tipe_std %>&id_master_std=<%=id_master_std %>&id_std=<%=id_std %>&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp%>&at_menu_dash=<%= at_menu_dash%>&fwdto=dashboard_std_manual_pelaksanaan_v1.jsp" style="text-decoration: none;" onclick="if (confirm('Apakah anda yakin akan mengaktifkan penggunaan manual ini ?!? \nSyarat Aktivasi:\n1. Draf manual telah melalui kegiatan perumusan, pemeriksaan, persetujuan dan penetapan.\n2. Pastikan draf manual telah diisi dengan benar, karena manual yg telah diaktifkan tidak dapat diedit')) return true;return false; ">
...
if(false) {
	%>	
		<tr>
			...
			<a class="img" href="<%=Constants.getRootWeb() %>/InnerFrame/Spmi/standar_spmi/form_manual/form_insert_manual_pelaksanaan_v1.jsp?mode=insert&id_tipe_std=<%=id_tipe_std %>&id_master_std=<%=id_master_std %>&id_std=<%=id_std %>&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp%>&at_menu_dash=<%= at_menu_dash%>&fwdto=dashboard_std_manual_pelaksanaan_v1.jsp" style="vertical-align:middle;valign:middle">
...
<h1 style="text-align:center;color:red">
	BELUM ADA MANUAL PELAKSANAAN STANDAR
</h1>
...
<%	
	...
	if(li.hasNext()) {
		...
		boolean man_expired = ts.apaManualSudahExpiredUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std), "PELAKSANAAN");
		String no_dok_spmi = ts.getPenomoranDokMutuUmum(id_std, "MANUAL", "PELAKSANAAN");
%>	
	<br>&nbsp<br>
<%
	...
	%>			
			...
			if(spmi_editor) {
					...
					<a href="#" onclick="if(confirm('Copy/Salin manual versi <%=id_versi%> ini untuk seluruh standar?\nCatatan:\nBila standar sudah memiliki manual versi <%=id_versi%> maka akan digantikan dengan salinan ini.'))(function(){
						...
						location.href='set.copyManForAll?status=aktif&tipe_manual=pelaksanaan&id_versi=<%=id_versi %>&id_tipe_std=<%=id_tipe_std %>&id_master_std=<%=id_master_std %>&id_std=<%=id_std %>&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp%>&at_menu_dash=<%= at_menu_dash%>&fwdto=dashboard_std_manual_pelaksanaan_v1.jsp'
						})();return false;"
					>
	...
	if(Checker.isStringNullOrEmpty(id_versi) || Checker.isStringNullOrEmpty(ts.getPenetapanTanggalManualUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std), "penetapan","perencanaan"))) {
		out.print("DRAFT ");
				...
				%>
	MANUAL PELAKSANAAN STANDARD</h1>
	<br><br>
	<table class="table0" id="table0" style="width:100%">
		<thead>	
			<tr>
	...
	<table class="table0" id="table0" style="width:100%">
		<thead>	
			...
			<tr>
				<th style="text-align:left;vertical-align:middle;width:100%;font-size:1.5em;font-weight:bold;padding:0 0 0 5px">
					2. TUJUAN DAN MAKSUD DOKUMEN MANUAL PELAKSANAAN STANDAR
				</th>
			</tr>
			<tr>	
			...
			<tr>
				<th style="text-align:left;vertical-align:middle;width:100%;font-size:1.5em;font-weight:bold;padding:0 0 0 5px">
					4. DEFINISI ISTILAH TERKAIT MANUAL PELAKSANAAN STANDAR
				</th>
			</tr>
			<tr>	
				<td style="background:white;text-align:left;vertical-align:middle;width:100%;font-size:0.9em;font-weight:bold;padding:5px 5px 5px 20px">
			...
			<tr>
				<th style="text-align:left;vertical-align:middle;width:100%;font-size:1.5em;font-weight:bold;padding:0 0 0 5px">
					5. PROSEDUR DAN LANGKAH PELAKSANAAN STANDAR 
				</th>
			</tr>
			<tr>	
				<td style="background:white;text-align:left;vertical-align:middle;width:100%;font-size:0.9em;font-weight:bold;padding:5px 5px 5px 20px">
...
<div id="upload">
<%
	session.setAttribute("ppepp_asal", "pelaksanaan");
	...
	%>
	<iframe id="glue"  onload="myFunction()" src="<%=Constants.getRootWeb() %>/InnerFrame/Spmi/standar_spmi/dashArsipPelaksanaan.jsp?kdpst=<%=kdpst %>&id_tipe_std=<%=id_tipe_std %>&id_master_std=<%=id_master_std %>&id_std=<%=id_std %>&id_versi=<%=versi_standar %>" seamless="seamless" width="100%" height="1000"  name="inner_iframe"></iframe>
</div>
<div id="kendali">
	<!-- sta kendali -->
<br>&nbsp<br>
...
if(v_kendal==null || v_kendal.size()<1) {
	//ada_penetapan_man= ts.apaSudahAdaPenetapanManual(Integer.parseInt(id_versi), Integer.parseInt(id_std_isi));
	boolean ada_penetapan_man= true;
	if(!ada_penetapan_man) {
		%>	
		<tr>
...
<%		
	...
	boolean man_sdh_aktif= ts.apaManualSudahAktifUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std), "pelaksanaan");
	if(!ada_penetapan_man||!man_sdh_aktif) {
	//if(false) {	
		String tmp = "Belum dapat melakukan kegiatan pengendalian, karena ";	
...
<%			
			...
			/*
			CEK APA ADA STANDARD YG AKTIF UTK ID_STD TERKAIT, TANPE MIKIR VERSINYA KRN STD VERSI BISA BEDA DENGAN VERSI MANUAL
			*/
			boolean std_aktif = ts.isStandardAdaYgAktif(Integer.parseInt(id_std));
...
<% 
			if(!std_aktif) {			
%>
			<table class="table2" id="tabel2" style="width:100%;border:none">
			<thead>
			<tr>
				<th colspan="2" style="font-size:1.5em;background:white;color:red;text-align:center;border:none">
					STANDAR BELUM AKTIF
				</th>
			</tr>
			</thead>
...
<%				
			...
			else if(v_list_std_isi!=null && std_aktif) {
	%>
		<table class="table2" id="tabel2" style="width:100%">
			<thead>
			<tr>
	...
	//tmp = id_versi+"`"+id_std_isi+"`"+id_std+"`"+isi_std+"`"+butir+"`"+kdpst+"`"+rasionale+"`"+tgl_sta+"`"+tgl_end+"`"+target1+"`"+target2+"`"+target3+"`"+target4+"`"+target5+"`"+target6+"`"+pihak+"`"+dokumen+"`"+indikator+"`"+periode_start+"`"+unit_used_by_periode_start+"`"+besaran_interval_per_period+"`"+unit_used_byTarget+"`"+pengawas+"`"+param+"`"+aktif+"`"+cakupan+"`"+tgl_mulai_aktif+"`"+tgl_stop_aktif+"`"+tipe_survey+"`"+id_master+"`"+id_tipe;
		...
		%>
			<tr onclick="window.location.href='<%=Constants.getRootWeb() %>/InnerFrame/Spmi/standar_spmi/form_manual_pelaksanaan/riwayat_kendali_mon_v1.jsp?backto=<%=backto %>&status_manual=<%=status_manual%>&starting_no=1&unit_used=<%=unit_used %>&scope_std=<%=scope_std%>&std_kdpst=<%=std_kdpst %>&id_versi=<%=id_versi_rs %>&id_tipe_std=<%=id_tipe_rs %>&id_master_std=<%=id_master_rs %>&id_std=<%=id_std_rs %>&id_std_isi=<%=id_std_isi_rs %>&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp %>&at_menu_kendal=riwayat&scope_std_isi=<%=cakupan_rs %>&at_menu_dash=do'" style="text-align:left;padding:0 2px;font-size:0.9em;padding:0 0 0 5px">
				<td style="border:none;width:2%;text-align:left;padding:5px 0 5px 5px">
					<%=no++ %>.
				</td>
				<td style="border:none;width:98%;text-align:left;padding:5px 2px 5px 5px;font-size:1.3em">
					...
					if(isi_std_rs!=null) {
						...
						out.print(isi_std_rs+" ("+cakupan_rs+")");
					}
					*/
								%>
				</td>
...
<%			
			...
			*/
			boolean std_aktif = ts.isStandardAdaYgAktif(Integer.parseInt(id_std));
			//System.out.println("std_aktif="+std_aktif);
			Vector v_list_std_isi = ssm.getListStandarIsi(spmi_editor,kdpst, Integer.parseInt(id_std));
%>		
		<tr>
			<td colspan="3" style="text-align:center;padding:0 0 0 0;font-size:0.9em;valign:middle">
...
<%				
	...
	%>
		<table class="table2" id="tabel2" style="width:100%">
			...
			<tr>
				<th colspan="2" style="font-size:1.5em">
					PILIH ISI STANDAR YG AKAN DI MONITOR
				</th>
			</tr>
	<%	
				int no=1;
	...
	//tmp = id_versi+"`"+id_std_isi+"`"+id_std+"`"+isi_std+"`"+butir+"`"+kdpst+"`"+rasionale+"`"+tgl_sta+"`"+tgl_end+"`"+target1+"`"+target2+"`"+target3+"`"+target4+"`"+target5+"`"+target6+"`"+pihak+"`"+dokumen+"`"+indikator+"`"+periode_start+"`"+unit_used_by_periode_start+"`"+besaran_interval_per_period+"`"+unit_used_byTarget+"`"+pengawas+"`"+param+"`"+aktif+"`"+cakupan+"`"+tgl_mulai_aktif+"`"+tgl_stop_aktif+"`"+tipe_survey+"`"+id_master+"`"+id_tipe;
				while(li.hasNext()) {
					...
					String id_master_rs = st.nextToken();
					String id_tipe_rs = st.nextToken();
					//System.out.println("id_tipe_rs="+id_tipe_rs);
		%>
			<tr onclick="window.location.href='<%=Constants.getRootWeb() %>/InnerFrame/Spmi/standar_spmi/form_manual_pelaksanaan/riwayat_monitor_v1.jsp?status_manual=<%=status_manual%>&starting_no=1&unit_used=<%=unit_used %>&scope_std=<%=scope_std%>&std_kdpst=<%=std_kdpst %>&id_versi=<%=id_versi_rs %>&id_tipe_std=<%=id_tipe_rs %>&id_master_std=<%=id_master_std %>&id_std=<%=id_std_rs %>&id_std_isi=<%=id_std_isi_rs %>&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp %>&at_menu_kendal=riwayat&at_menu_dash=do'" style="text-align:left;padding:0 2px;font-size:0.9em;padding:0 0 0 5px">
				<td style="border:none;width:2%;text-align:left;padding:5px 0 5px 5px">
					<%=no++ %>.
				</td>
				<td style="border:none;width:98%;text-align:left;padding:5px 2px 5px 5px;font-size:1.3em">
