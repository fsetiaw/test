...
boolean next=false;
boolean prev = false;
Vector v_hist_eval=shk.getListRiwayatPelaksanaanUmum(Integer.parseInt(id_versi), Integer.parseInt(id_std),offset,(Integer.parseInt(src_manual_limit)));
int tot_rec = 0;
if(v_hist_eval!=null) {
