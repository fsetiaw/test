...
<div id="main">
    ...
    %>
   				<a href="go.getListAllStd?mode=view&id_tipe_std=<%=id %>&id_master_std=<%=id_master %>&atMenu=&kdpst_nmpst_kmp=<%=kdpst_nmpst_kmp %>&at_page=1&max_data_per_pg=5" target="inner_iframe" class="tile bg-darkOrange fg-white" data-role="tile">
            		<div class="padding20">
	               	<p class="no-margin text-shadow"><span class="text-bold"><%=keter %></p>
					</div>
				</a>
    <%
    }
