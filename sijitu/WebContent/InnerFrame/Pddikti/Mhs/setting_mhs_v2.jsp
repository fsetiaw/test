...
<%
	...
	String target_tkn_kdpst = (String)session.getAttribute("target_tkn_kdpst");
	...
	if(Checker.isStringNullOrEmpty(target_tkn_kdpst)) {
		v = sdt.getListKelasKuliahForFeeder_v1(target_thsms);
		
	}
	else {
		v = sdt.getListKelasKuliahForFeeder_v1(target_thsms,target_tkn_kdpst);
	}
