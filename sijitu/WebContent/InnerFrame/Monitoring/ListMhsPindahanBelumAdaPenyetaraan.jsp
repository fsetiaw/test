...
//System.out.println("v_list_mhs22="+v_list_mhs.size());
...
//	//System.out.println("baris == "+brs_info);
...
<center>
	...
	<table class="table">
		<thead>
		<tr>
	  		<th colspan="5" style="text-align: center; padding: 0px 10px;font-size:1.5em">LIST MAHASISWA BELUM ADA DATA MATAKULIAH PENYETARAAN </th>
	  	</tr>
	  	<tr>
  			<th width="5%">NO</th>
