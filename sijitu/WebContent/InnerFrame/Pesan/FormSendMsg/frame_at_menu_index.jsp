...
<iframe id="sub_glu" src="<%=Constants.getRootWeb() %>/InnerFrame/Pesan/conversation_main_frame.jsp?str_range=<%=Constant.rangeMsgPerPage() %>&grp_nm=<%=grp_nm %>&grp_id=<%=grp_id %>" seamless="seamless" width="100%" height="1600px" onload="scroll(0,0);resize_iframe()" name="sub2_inner_iframe"></iframe>
</body>
</html>