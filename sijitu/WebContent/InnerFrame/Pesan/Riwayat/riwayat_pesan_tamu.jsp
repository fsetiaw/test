...
<table class="table">
	<thead>
	<tr>
  		<th colspan="4" style="text-align: center; padding: 0px 10px;font-size:1.5em">RIWAYAT PESAN TAMU</th>
  	</tr>
  	<tr>
  		<th width="5%">NO</th>
 ...
 %> 	
  	<tr>
		...
		<td align="center" style="vertical-align: middle; padding: 0px 5px"><%=nmmhs %></td>
		<td align="left" style="vertical-align: middle; padding: 0px 5px"><%=isi_topik %><br>(<%=target %>)</td>
