...
"20201`ELEKTRO","22201`SIPIL","23201`ARSITEK","26201`INDUSTRI","54201`AGRIBIS","54211`AGROTEK","55201`INFORMATIKA","61101`MM","61201`MANAGEMEN","62201`AKUNTANSI","64201`HI","65001`DIMP","65101`MIP","65201`IP","74201`HUKUM","88888`agama","93402`HOTEL"
  ...
  <%
  String prodi = request.getParameter("tags");
...
<body>
	...
	while(li.hasNext()) {
		...
		while(lisma.hasNext()) {
			...
			<form action="update_ko.jsp" method="post">
			...
			%>
				...
				<table width="90%">
					...
					<tr>
						...
						%>
							KO [<%=st2.countTokens() %>]<input type="text" name="target_ko" style="width:99%"/>
						</td>
					</tr>
					<tr>
						<td>
			...
			while(likur.hasNext()) {
				...
				while(lik.hasNext()) {
					...
					while(lit.hasNext()) {
						...
						out.print("&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ("+no+")"+info_mk+"<br>");
					}
				}
				*/
			}
