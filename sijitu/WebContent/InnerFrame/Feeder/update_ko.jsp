...
<head>
  ...
  <script src="<%=Constants.getRootWeb() %>/js/jquery-ui.js"></script>
	...
	String[]target_ko = request.getParameterValues("target_ko");
...
<body>
	...
	udf.updateKo(list_npm[0], target_ko[0]);
	%>
	<%=angkatan[0] %><br>
	<%
	...
	%><br>
	<%=target_ko[0] %><br>
	<jsp:forward page="info_prodi.jsp">
	<jsp:param value="<%=prodi[0] %>" name="tags"/> 
