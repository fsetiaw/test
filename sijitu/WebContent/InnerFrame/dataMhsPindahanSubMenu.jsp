...
<ul>
	<li><a href="get.profile_v1?id_obj=<%=v_id_obj%>&nmm=<%=v_nmmhs%>&npm=<%=v_npmhs %>&obj_lvl=<%=v_obj_lvl %>&kdpst=<%=v_kdpst %>&cmd=profile&atMenu=pindahan" target="_self">BACK <span><b style="color:#eee">&nbsp</b></span></a></li>
	<%	
	/*
