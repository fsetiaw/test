	...
	li = v_overview.listIterator();
		while(li.hasNext()) {
			...
			while(litmp.hasNext()) {
				...
				tot_keluar_wip = tot_keluar_wip+Integer.parseInt(tot_ou_wip);
				...
				String no_info_penyetaraan = st.nextToken();
				String ada_nilai_tunda = st.nextToken();
				String no_pengajuan_kls_req = st.nextToken();
				String pengajuan_kls_req_wip = st.nextToken();
				String no_kegiatan_perkuliahan = st.nextToken();
				String tot_lu = st.nextToken();
				String tot_lu_wip = st.nextToken();
				String list_npm_lu_wip = st.nextToken();
				tot_lulus_wip = tot_lulus_wip+Integer.parseInt(tot_lu_wip);
				tot_lulus=tot_lulus+Integer.parseInt(tot_lu);
			...
			StringTokenizer st2 = new StringTokenizer(scope_kampus,",");
			
			boolean match = false;
			while(st2.hasMoreTokens() && !match) {
				String kode = st2.nextToken();
				if(target_kampus.equalsIgnoreCase(kode)) {
					match = true;					
				}
			}
			if(match) { //kampus aktif only
			...
			<div class="tile-container">
				<div class="tile bg-amber fg-white" data-role="tile">  
					...
					<div style="margin:110px 0 0 60px;position: absolute;">   
        	       		...
        	       		<p class="no-margin text-shadow"><span class="text-bold" id="pressure">
        	       		<%
						if(tot_pmb>0) {
				%>
	            			<a href="#" target="inner_iframe" style="color:white">
	            			<%=tot_pmb %>
	            			</a>
	            <%
						}
	            ...
	            <div class="tile bg-darkOrange fg-white" data-role="tile">  
					...
					<div style="margin:110px 0 0 50px;position: absolute;">   
						...
						if(tot_her>0) {
				%>
	            			<a href="get.whoRegister?target_thsms=<%=target_thsms%>&at_kmp=<%=target_kampus %>" target="inner_iframe" style="color:white">
	            			<%=tot_her %>
	            			</a>
	            <%
						}
				...
				<div class="tile bg-amber fg-white" data-role="tile">  
					...
					<div style="margin:110px 0 0 50px;position: absolute;">   
						...
						if(no_krs>0) {
				%>
	            			<a href="get.whoNoKrs?target_thsms=<%=target_thsms%>" target="inner_iframe" style="color:white">
	            			<%=no_krs %>
	            			</a>
	            <%
						}
	            ...
	            %> 
	          	...
	          	<!--  a class="tile bg-darkOrange fg-white" data-role="tile" href="get.sebaranTrlsm" target="inner_iframe" -->    
					...
					<div style="margin:70px 0 0 10px;position: absolute;">   
	               		<p class="no-margin text-shadow"><span class="text-bold" id="pressure">MASUK :
	               		<%
						if(tot_pp_in>0) {
				%>
	            			<a href="#" target="inner_iframe" style="color:white">
	            ...
	            %>  
					...
					<div style="margin:85px 0 0 10px;position: absolute;">   
	               		<p class="no-margin text-shadow"><span class="text-bold" id="pressure">KELUAR:
	               		<%
						if(tot_pp_out>0) {
				%>
	            			<a href="#" target="inner_iframe" style="color:white">
	            ...
	            %>  
					...
					<div style="margin:110px 0 0 10px;position: absolute;">   
	               		<p class="no-margin text-shadow"><span class="text-bold" id="pressure">DALAM PROSES:
	               		<%
						if(tot_pp_wip>0) {
				%>
	            			<a href="#" target="inner_iframe" style="color:white">
	            ...
	            %>  
		   		...
		   		<div class="tile bg-amber fg-white" data-role="tile">  
					...
					<div style="margin:110px 0 0 50px;position: absolute;">   
						...
						if(tot_cuti>0) {
				%>
	            			<a href="go.getWhoRequest?fullname_table_rules=CUTI_RULES&target_thsms=<%=target_thsms %>" target="inner_iframe" style="color:white">
	            			<%=tot_cuti %>
	            			</a>
	            <%
						}
	            ...
	            %>
	          	...
	          	<div class="tile bg-darkOrange fg-white" data-role="tile"> 	
					...
					<div style="margin:30px 0 0 10px;position: absolute;">   
	               		<p class="no-margin text-shadow"><span class="text-bold" id="pressure">KELUAR/DALAM PROSES PERSETUJUAN</span></p>
					</div>
					<div style="margin:60px 0 0 30px;position: absolute;">   
	               		<p class="no-margin text-shadow"><span class="text-bold" id="pressure">&nbsp</span></p>
					</div>
					...
					<div style="margin:110px 0 0 50px;position: absolute;">   
						...
						if(tot_keluar>0) {
				%>
	            			<a href="#" id="getListMhsKeluar" target="inner_iframe" style="color:white">
	            			<%=tot_keluar %>
	            			</a>
	            <%
						}
	            ...
	            %>	</span></p>
	          	...
	          	<div class="tile bg-amber fg-white" data-role="tile">  
					...
					<div style="margin:30px 0 0 10px;position: absolute;">   
	               		<p class="no-margin text-shadow"><span class="text-bold" id="pressure">LULUS / PROSES PERSETUJUAN </span></p>
					</div>
					<div style="margin:60px 0 0 30px;position: absolute;">   
	               		<p class="no-margin text-shadow"><span class="text-bold" id="pressure">&nbsp</span></p>
					</div>
					...
					<div style="margin:110px 0 0 50px;position: absolute;">   
						...
						if(tot_lulus>0) {
				%>
	            			<a href="go.getWhoRequest?fullname_table_rules=KELULUSAN_RULES&target_thsms=<%=target_thsms %>&target_kampus=<%=target_kampus %>" target="inner_iframe" style="color:white">
	            			<%=tot_lulus %>
	            			</a>
	            <%
						}
	            ...
	            <%
						if(tot_lulus>0) {
				%>
	            			<a href="go.getWhoRequest?fullname_table_rules=KELULUSAN_RULES&target_thsms=<%=target_thsms %>" target="inner_iframe" style="color:white">
	            			<%=tot_lulus_wip %>
	            			</a>
	            <%
						}
