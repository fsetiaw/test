...
<div class="colmask fullpage">
	<div class="col1">
		<br />
		<!-- Column 1 start -->
		<iframe name="mf" id="mainFrame" src="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/ContactUs/tampleteMainPost.jsp?atMenu=baa&targetObjNickName=<%=targetObjNickName %>" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:600px; height:100%" allowTransparency="true"></iframe>
		<iframe name="smf" id="subMainFrame" src="<%=Constants.getRootWeb()+"/" %>${PageContext.ServletContext.ContextPath}/InnerFrame/ContactUs/tampleteTopic.jsp?atMenu=baa&targetObjNickName=<%=targetObjNickName %>&xy=0,<%=Constants.getQuantityMsgShownPerPage() %>&unreadInfo=<%=unreadInfo %>" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:600px; height:100%;" allowTransparency="true"></iframe>
		<!-- Column 1 start -->
	</div>
</div>		
</body>
