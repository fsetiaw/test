...
%>		
			<input type="hidden" value="<%=id_obj %>" name="id_obj" /><input type="hidden" value="<%=obj_lvl %>" name="obj_lvl" /><input type="hidden" value="<%=nmm %>" name="nmm" />
			<input type="hidden" value="<%=nim %>" name="nim" /><input type="hidden" value="<%=npm %>" name="npm" /><input type="hidden" value="<%=kdpst %>" name="kdpst" />
				...
				<tr>
					...
					<section class="gradient">
						<div style="text-align:center">
							<button type="submit" style="padding: 5px 50px;font-size: 20px;">Update Jabatan</button>
					<!--  input type="submit" class="btn btn-primary" value="Update Jabatan" --></td>	
						</div>
					</section>	
				</tr>
<%
