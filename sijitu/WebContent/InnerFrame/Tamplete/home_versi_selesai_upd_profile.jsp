...
%>
    ...
    <style>
        ...
        .schemeBuwajib_update_profilettons {
            /*width: 300px;*/
        }
    ...
    <div class="tile-area tile-area-scheme-dark fg-white" style="height: 100%; max-height: 100% !important;">
        <div class="tile-group quadro">
			...
			<div class="tile-container">
				<a href="index.jsp" target="inner_iframe" class="tile-wide bg-green fg-white" data-role="tile">
	     		    <div style="padding:5px 5px;font-size:1.3em;font-weight:bold;text-align:center">
                	<br>DATA PROFIL BERHASIL DI UPDATE<BR><BR>SILAHKAN KLIK DISINI UNTUK MELANJUTKAN
					</div>
            	</a>
     		</div>
  		</div>     
