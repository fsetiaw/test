...
/**
 * Session Bean implementation class UpdHistPlan
 */
@Stateless
@LocalBean
public class UpdHistPerencanaan_tidakDiPaek extends UpdateDb {
	String operatorNpm;
	String operatorNmm;
     ...
     */
    public UpdHistPerencanaan_tidakDiPaek() {
        super();
     ...
     */
    public UpdHistPerencanaan_tidakDiPaek(String operatorNpm) {
        super(operatorNpm);
    ...
    public int updateRiwayatPerencanaan_deprecated(String id_plan,String id_versi,String id_std_isi,String norut_man,String tgl_sta,String waktu_sta,String nama_kegiatan,String jenis_kegiatan,String tujuan_kegiatan,String isi_kegiatan,String[] job_jawab,String[]job_target,String[]dok_kegiatan,String status_kegiatan_sdh_mulai) {
    	int updated=0;
    	try {
    ...
    public int updateRiwayatHasilPerencanaan_deprecated(String id_plan, String hasil, String note, String tgl_end, String waktu_end, String sebagai_tgl_penetapan, String versi_id, String std_isi_id, String norut_man) {
    	int updated=0;
    	try {
    		Context initContext  = new InitialContext();
        	Context envContext  = (Context)initContext.lookup("java:/comp/env");
