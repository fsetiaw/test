...
@Stateless
@LocalBean
public class UpdHistPeningkatan extends UpdateDb {
	String operatorNpm;
	String operatorNmm;
     ...
     */
    public UpdHistPeningkatan(String operatorNpm) {
        super(operatorNpm);
    ...
    public int updateRiwayatPeningkatanUmum(String id_plan,String id_versi,String id_std,String tgl_sta,String waktu_sta,String nama_kegiatan,String jenis_kegiatan,String tujuan_kegiatan,String isi_kegiatan,String[] job_jawab,String[]job_target,String[]dok_kegiatan,String status_kegiatan_sdh_mulai) {
    	int updated=0;
    	try {
    		Context initContext  = new InitialContext();
        	Context envContext  = (Context)initContext.lookup("java:/comp/env");
        	...
        	if(Checker.isStringNullOrEmpty(id_plan)) {
        		//System.out.println("insert mode--");
        		String sql = "INSERT INTO RIWAYAT_PENINGKATAN_UMUM(VERSI_ID,ID_STD,TGL_STA_KEGIATAN,WAKTU_STA_KEGIATAN,TIMESTAMP_KEGIATAN_STA,NAMA_KEGIATAN,JENIS_KEGIATAN,KETERANGAN_SINGKAT_TUJUAN_KEGIATAN,ISI_KEGIATAN,PENANGGUNG_JAWAB_KEGIATAN,AUDIENCE_KEGIATAN,DOKUMEN_KEGIATAN,KEGIATAN_STARTED)values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
        		stmt = con.prepareStatement(sql);
        		int i=1;
        		//VERSI_ID
        		stmt.setInt(i++, Integer.parseInt(id_versi));
        		...
        		//System.out.println("update mode--"); 
        		//String sql = "UPDATE RIWAYAT_PENINGKATAN set TGL_STA_KEGIATAN=?,WAKTU_STA_KEGIATAN=?,TIMESTAMP_KEGIATAN_STA=?,NAMA_KEGIATAN=?,JENIS_KEGIATAN=?,KETERANGAN_SINGKAT_TUJUAN_KEGIATAN=?,ISI_KEGIATAN=?,PENANGGUNG_JAWAB_KEGIATAN=?,AUDIENCE_KEGIATAN=?,DOKUMEN_KEGIATAN=?,KEGIATAN_STARTED=? where VERSI_ID=? and STD_ISI_ID=? and NORUT=?";
        		String sql = "UPDATE RIWAYAT_PENINGKATAN_UMUM set TGL_STA_KEGIATAN=?,WAKTU_STA_KEGIATAN=?,TIMESTAMP_KEGIATAN_STA=?,NAMA_KEGIATAN=?,JENIS_KEGIATAN=?,KETERANGAN_SINGKAT_TUJUAN_KEGIATAN=?,ISI_KEGIATAN=?,PENANGGUNG_JAWAB_KEGIATAN=?,AUDIENCE_KEGIATAN=?,DOKUMEN_KEGIATAN=?,KEGIATAN_STARTED=? where ID_PLAN=?";
        		stmt = con.prepareStatement(sql);
        		int i=1;
        		//TGL_STA_KEGIATAN
        		if(Checker.isStringNullOrEmpty(tgl_sta)) {
    ...
    public int updateRiwayatHasilPeningkatan_v1(String id_plan, String hasil, String note, String tgl_end, String waktu_end, String sebagai_tgl_penetapan, String versi_id, String id_std) {
    	int updated=0;
    	try {
    		Context initContext  = new InitialContext();
        	Context envContext  = (Context)initContext.lookup("java:/comp/env");
        	...
        	if(sebagai_tgl_penetapan!=null&&sebagai_tgl_penetapan.contains("_std")) {
        		 ...
        		 * UPDATE TGL TSTD
        		 */
        		String sql = "UPDATE RIWAYAT_PENINGKATAN_UMUM set KETERANGAN_HASIL_KEGIATAN=?,NOTE=?,TGL_END_KEGIATAN=?,WAKTU_END_KEGIATAN=?,TIMESTAMP_KEGIATAN_END=?,KEGIATAN_SELESAI=?,TGL_RUMUS_STD=?,TGL_CEK_STD=?,TGL_STUJU_STD=?,TGL_TETAP_STD=?,TGL_KENDALI_STD=? where ID_PLAN=?";
        		stmt = con.prepareStatement(sql);
        		int i=1;
        		//KETERANGAN_HASIL_KEGIATAN=?,
        		stmt.setString(i++, hasil);
            	...
            	if(updated>0 && !Checker.isStringNullOrEmpty(sebagai_tgl_penetapan) && !sebagai_tgl_penetapan.equalsIgnoreCase("no")) {
            		i=1;
            		if(sebagai_tgl_penetapan.equalsIgnoreCase("rumus_std")) {
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_RUMUS_STD=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
        				...
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_CEK_STD=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
        				...
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_STUJU_STD=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
        			}
        			else if(sebagai_tgl_penetapan.equalsIgnoreCase("tetap_std")) {
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_TETAP_STD=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
        			}
        			else if(sebagai_tgl_penetapan.equalsIgnoreCase("kendali_std")) {
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_KENDALI_STD=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
        			}
        		...
        		// UPDATE TGL MANUAL
        		String sql = "UPDATE RIWAYAT_PENINGKATAN_UMUM set KETERANGAN_HASIL_KEGIATAN=?,NOTE=?,TGL_END_KEGIATAN=?,WAKTU_END_KEGIATAN=?,TIMESTAMP_KEGIATAN_END=?,KEGIATAN_SELESAI=?,TGL_RUMUS=?,TGL_CEK=?,TGL_STUJU=?,TGL_TETAP=?,TGL_KENDALI=? where ID_PLAN=?";
        		stmt = con.prepareStatement(sql);
        		int i=1;
        		//KETERANGAN_HASIL_KEGIATAN=?,
        		stmt.setString(i++, hasil);
            	...
            	if(updated>0 && !Checker.isStringNullOrEmpty(sebagai_tgl_penetapan) && !sebagai_tgl_penetapan.equalsIgnoreCase("no")) {
            		i=1;
            		if(sebagai_tgl_penetapan.equalsIgnoreCase("rumus")) {
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_RUMUS=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
        				...
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_CEK=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
        				...
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_STUJU=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
        			}
        			else if(sebagai_tgl_penetapan.equalsIgnoreCase("tetap")) {
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_TETAP=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
        			}
        			else if(sebagai_tgl_penetapan.equalsIgnoreCase("kendali")) {
        				stmt = con.prepareStatement("update STANDARD_MANUAL_PENINGKATAN_UMUM set TGL_KENDALI=? where VERSI_ID=? and ID_STD=?");
        				stmt.setDate(i++, java.sql.Date.valueOf(tgl_end));
        				stmt.setInt(i++, Integer.parseInt(versi_id));
        				stmt.setInt(i++, Integer.parseInt(id_std));
