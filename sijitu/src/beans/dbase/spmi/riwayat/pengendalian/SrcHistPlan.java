...
/**
 * Session Bean implementation class SrcHistPlan
 */
@Stateless
@LocalBean
public class SrcHistPlan extends SearchDb {
	String operatorNpm;
	String operatorNmm;
     ...
     */
    public SrcHistPlan(String operatorNpm) {
        super(operatorNpm);
     ...
     */
    public SrcHistPlan(Connection con) {
        super(con);
        // TODO Auto-generated constructor stub
    }
    ...
    public Vector getListRiwayatPerencanaan_deprecated(int versi_id, int std_isi_id, int norut_man, int offset, int limit) {
    	/*
