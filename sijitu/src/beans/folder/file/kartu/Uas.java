...
/**
 * Session Bean implementation class Uas
 */
@Stateless
@LocalBean
public class Uas extends FileManagement {
	String schema,kdpst,npm;   
    /**
     * @see FileManagement#FileManagement(String)
     */
    public Uas(String schema) {
        super(schema);
        this.schema=schema;
    ...
    public void prepKartuUas(String thsms,String kdpst,String nmfak,String nmpst,String nimhs,String  nmmhs,Vector vKdmk_nakmk,String namaUjian,String outNameFile,String namaPencetak,String namaValidator) {
    	java.io.File file = new File(Constants.getRootMasterKartuUjianFile()+"/"+namaUjian+"/"+Constants.getNamaFileMasterKartuUjian());
    	//System.out.println("out file = "+Constants.getRootMasterKartuUjianFile()+"/"+namaUjian+"/"+Constants.getNamaFileMasterKartuUjian());
