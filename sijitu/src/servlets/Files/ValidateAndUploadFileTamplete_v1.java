...
import listeners.*;
/**
 * Servlet implementation class ValidateAndUploadFileTamplete_v1
 */
@WebServlet("/ValidateAndUploadFileTamplete_v1")
public class ValidateAndUploadFileTamplete_v1 extends HttpServlet implements Servlet {
     ...
     */
    public ValidateAndUploadFileTamplete_v1() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("doGet ValidateAndUploadFileTamplete_v1");
	...
	{
		System.out.println("validate form doPusr _ version1");
		...
		if(isu==null) { 
			...
			//if(false) {
	    		...
	    		if(valid) {
	    			...
	    			fwdPageIfValid = "DashUjianAkhir_part2.jsp?id_obj="+idobj+"&nmm="+nmmhs+"&npm="+npmhs+"&obj_lvl="+objlv+"&kdpst="+kdpst+"&cmd=ua";
