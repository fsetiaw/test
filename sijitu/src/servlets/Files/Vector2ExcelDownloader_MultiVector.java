 ...
 */
@WebServlet("/Vector2ExcelDownloader_2Vector")
public class Vector2ExcelDownloader_MultiVector extends HttpServlet {
...
//    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Vector v_multi_header= (Vector)session.getAttribute("v_multi_header");
		Vector v_multi_body= (Vector)session.getAttribute("v_multi_body");
		//session.removeAttribute("v");
		//System.out.println("okay");
		//System.out.println("v_header.size="+v_header.size());
		//System.out.println("v_body.size="+v_body.size());
		//System.out.println("output_file_name="+output_file_name);
		FileManagement fm = new FileManagement();
		fm.prepEmptyExcel(v_multi_header,v_multi_body, output_file_name);
