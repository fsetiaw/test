...
/**
 * Servlet implementation class UploadFileGeneric
 */
@WebServlet("/UploadFileGeneric")
public class UploadFileGeneric extends HttpServlet {
...
//    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            String uploadTo = Constants.getIncomingUploadFile()+"/";
                            ...
                            if(st.countTokens()<1) {
                            	...
                            	//empty file
                            		...
                            		if(item.getSize()>2000000) {
                                        ...
                                        //fileName = fileName+"-"+AskSystem.getCurrentTimeInString()+"_"+isu.getIdUser()+"."+ext;
                                        //String idUser = ""+isu.getIdUser();
                                        //System.out.println("6a");
                                        //System.out.println("filename="+fileName);
                                        //System.out.println("uploadto=");
                                        File fileTo = null;
                                        CharSequence cs1 = "html";
                                        CharSequence cs2 = "php";
                                        CharSequence cs3 = "jsp";
                                        System.out.println("filename = "+fileName);
                                        System.out.println("ext = "+ext);
                                        if(ext.contains(cs1)||ext.contains(cs2)||ext.contains(cs3)) {
                                        	fileName = fileName+"."+ext;
                                        	fileTo = new File(uploadToIfLoginHtml + fileName);
                                        	System.out.println(uploadToIfLoginHtml);
                                        }
                                        else {
                                        	fileName = fileName+"-"+AskSystem.getCurrentTimeInString()+"_"+isu.getIdUser()+"."+ext;
                                        	fileTo = new File(uploadTo + fileName);
                                        	System.out.println(uploadTo);
                                        }
