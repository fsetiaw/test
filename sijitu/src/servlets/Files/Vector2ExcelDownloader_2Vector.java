...
public class Vector2ExcelDownloader_2Vector extends HttpServlet {
...
//    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Vector v_header= (Vector)session.getAttribute("v_header");
		Vector v_body= (Vector)session.getAttribute("v_body");
		...
		fm.prepEmptyExcel(v_header,v_body, output_file_name);
