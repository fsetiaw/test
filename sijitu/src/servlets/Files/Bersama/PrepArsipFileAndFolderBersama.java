package servlets.Files.Bersama;
...
/**
 * Servlet implementation class PrepArsipFileAndFolderBersama
 */
@WebServlet("/PrepArsipFileAndFolderBersama")
public class PrepArsipFileAndFolderBersama extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrepArsipFileAndFolderBersama() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			String root_shared_folder = Checker.getRootSharedFolder();
			File fileTo =  null; 
			/*
			...
			*/
			File f = new File(root_shared_folder);
			...
			String target = Constants.getRootWeb()+"/InnerFrame/Arsip/Bersama/tampletIndexArsip.jsp"; 
			...
			request.getRequestDispatcher(url+"?list_folder_at_root_dir="+list_folder_at_root_dir+"&root_shared_folder="+root_shared_folder).forward(request,response);
		}
