package servlets.process.ua_rules;
...
/**
 * Servlet implementation class PrepUjianAkhir
 */
@WebServlet("/PrepUjianAkhir")
public class PrepUjianAkhir extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrepUjianAkhir() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			String table_rule_name = "UJIAN_AKHIR_RULES";
