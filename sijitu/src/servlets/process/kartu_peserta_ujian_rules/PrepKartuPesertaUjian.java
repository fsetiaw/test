package servlets.process.kartu_peserta_ujian_rules;
...
/**
 * Servlet implementation class PrepKartuPesertaUjian
 */
@WebServlet("/PrepKartuPesertaUjian")
public class PrepKartuPesertaUjian extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrepKartuPesertaUjian() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			/*
			 * perhatikan TARGET THSMS YG DIPAKE 
			 * 2. TABEL RULE NAME
			 */
			String target_thsms = Checker.getThsmsNow();
					
			String table_rule_name = "KARTU_PESERTA_UJIAN_RULES";
