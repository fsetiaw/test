package servlets.process.pengajuan_kelas_rules;
...
/**
 * Servlet implementation class PrepPengajuanKelas
 */
@WebServlet("/PrepPengajuanKelas")
public class PrepPengajuanKelas extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrepPengajuanKelas() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			String table_rule_name = "KELAS_PERKULIAHAN_RULES";
