 ...
 */
@WebServlet("/PrepFormPengaturanPerintah")
public class PrepFormPengaturanPerintah extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrepFormPengaturanPerintah() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			String target = Constants.getRootWeb()+"/InnerFrame/Parameter/Cmd/dashCmd.jsp";
