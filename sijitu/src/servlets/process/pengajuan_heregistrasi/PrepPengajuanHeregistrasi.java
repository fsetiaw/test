package servlets.process.pengajuan_heregistrasi;
...
/**
 * Servlet implementation class PrepPengajuanHeregistrasi
 */
@WebServlet("/PrepPengajuanHeregistrasi")
public class PrepPengajuanHeregistrasi extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrepPengajuanHeregistrasi() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			String table_rule_name = "HEREGISTRASI_RULES";
			...
			System.out.println("alm_folder="+alm_folder);
