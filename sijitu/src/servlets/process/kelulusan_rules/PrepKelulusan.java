package servlets.process.kelulusan_rules;
...
/**
 * Servlet implementation class PrepKelulusan
 */
@WebServlet("/PrepKelulusan")
public class PrepKelulusan extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrepKelulusan() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			String table_rule_name = "KELULUSAN_RULES";
