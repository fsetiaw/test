...
public class ShowImage extends HttpServlet {
        ...
        throws ServletException, IOException
    {
    	...
    	String target_npmhs = request.getParameter("npmhs");
        ...
        imagePath = Checker.getRootFolderIndividualMhs(target_npmhs)+"/FOTO";
        requestedImage = imagePath+"/"+requestedImage;
        //File imageFolder= new File(imagePath);
        //File []list_file = imageFolder.listFiles();
        ...
        if (!image.exists()) {
            ...
            return;
            */
        	requestedImage = Constants.getFolderPassPhoto()+"/android.jpg";
            //System.out.println("requestedImage="+requestedImage);
