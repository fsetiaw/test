...
/**
 * Servlet implementation class CekKonflikAntaraKrsDgnStatusAkhir
 */
@WebServlet("/CekKonflikAntaraKrsDgnStatusAkhir")
public class CekKonflikAntaraKrsDgnStatusAkhir extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CekKonflikAntaraKrsDgnStatusAkhir() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			Vector v = mdt.cekErrorKonflikAntaraKrsDgnStmhs(thsms);
			//System.out.println("size1="+v.size());
			if(v!=null && v.size()>0) {
				//kdpst+"`"+npmhs+"`"+nmmhs+"`"+nimhs+"`"+smawl+"`"+stpid+"`"+angel+"`"+kdjen

				//System.out.println("size="+v_npmhs.size());
				v.add(0,"NPMHS`KETERANGAN");
				v.add(0,"600px");
				v.add(0,"20`75");
				v.add(0,"center`left");
