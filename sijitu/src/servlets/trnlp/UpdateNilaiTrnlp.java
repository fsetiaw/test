...
/**
 * Servlet implementation class UpdateNilaiTrnlp
 */
@WebServlet("/UpdateNilaiTrnlp")
public class UpdateNilaiTrnlp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateNilaiTrnlp() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			if(list_npm_pindahan_dlm_1_angkatam!=null && !Checker.isStringNullOrEmpty(list_npm_pindahan_dlm_1_angkatam)) {
				...
				udt.updNilaiTrnlp(list_npm_pindahan_dlm_1_angkatam);	
			}
