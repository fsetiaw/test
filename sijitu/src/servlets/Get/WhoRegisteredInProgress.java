...
/**
 * Servlet implementation class WhoRegisteredInProgress
 */
@WebServlet("/WhoRegisteredInProgress")
public class WhoRegisteredInProgress extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WhoRegisteredInProgress() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("who WhoRegisteredInProgress");
		...
		//kode here
			...
			if(v_scope_id!=null && v_scope_id.size()>0) {
				...
				//vf = sddu.getInfoDaftarUlangFilterByScopeAndUnapproved_v1(target_thsms,v_scope_id);
				vf = sddu.getInfoDaftarUlangFilterByScopeFinale_v1(target_thsms,v_scope_id,true);
			...
			String target = Constants.getRootWeb()+"/InnerFrame/DaftarUlang/main_index.jsp";
