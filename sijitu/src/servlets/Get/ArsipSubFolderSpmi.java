...
/**
 * Servlet implementation class ArsipSubFolderSpmi
 */
@WebServlet("/ArsipSubFolderSpmi")
public class ArsipSubFolderSpmi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ArsipSubFolderSpmi() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			*/
			...
			String target = Constants.getRootWeb()+"/InnerFrame/Arsip/folderContentSpmi.jsp";
