 ...
 */
@WebServlet("/ArsipSubFolderBersama_v1")
public class ArsipSubFolderBersama_v1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ArsipSubFolderBersama_v1() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			*/
			...
			String target = Constants.getRootWeb()+"/InnerFrame/Arsip/Bersama/folderContent_v1.jsp";
			...
			String redirect = response.encodeRedirectURL(url_ff+"?list_folder_at_root_dir="+list_folder_at_root_dir+"&root_dir="+root_dir+"&cur_dir="+alm+"&keter="+keter+"&hak="+hak+"&scope="+scope+"&callerPage="+callerPage+"&cmd="+cmd+"&atMenu="+atMenu+"&scopeType="+scopeType);
