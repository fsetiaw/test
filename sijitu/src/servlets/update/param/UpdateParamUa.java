...
/**
 * Servlet implementation class UpdateParamUa
 */
@WebServlet("/UpdateParamUa")
public class UpdateParamUa extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateParamUa() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			try {
				...
				request.getRequestDispatcher("prep.prepParamUARules?atMenu="+scopeCmd).forward(request,response);
			}
			catch(Exception e) {}
