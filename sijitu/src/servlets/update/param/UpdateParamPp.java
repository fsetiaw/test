...
/**
 * Servlet implementation class UpdateParamPp
 */
@WebServlet("/UpdateParamPp")
public class UpdateParamPp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateParamPp() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			try {
				...
				request.getRequestDispatcher("prep.prepParamPindahProdiRules?atMenu=pp").forward(request,response);
			}
			catch(Exception e) {}
