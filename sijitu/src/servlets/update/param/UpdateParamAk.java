...
/**
 * Servlet implementation class UpdateParamAk
 */
@WebServlet("/UpdateParamAk")
public class UpdateParamAk extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateParamAk() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			try {
				...
				request.getRequestDispatcher("prep.prepParamAktifRules?atMenu="+scopeCmd).forward(request,response);
			}
			catch(Exception e) {}
		}	
	}
