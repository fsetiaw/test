...
/**
 * Servlet implementation class UpdateParamKrl
 */
@WebServlet("/UpdateParamKrl")
public class UpdateParamKrl extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateParamKrl() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			try {
				...
				request.getRequestDispatcher("prep.prepParamKeluarRules?atMenu="+scopeCmd).forward(request,response);
			}
			catch(Exception e) {}
