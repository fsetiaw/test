...
/**
 * Servlet implementation class UpdateParamKk
 */
@WebServlet("/UpdateParamKk")
public class UpdateParamKk extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateParamKk() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			try {
				...
				request.getRequestDispatcher("prep.prepParamPengajuanKelasRules?atMenu="+scopeCmd).forward(request,response);
			}
			catch(Exception e) {}
