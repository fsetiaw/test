...
/**
 * Servlet implementation class UpdateParamCt
 */
@WebServlet("/UpdateParamCt")
public class UpdateParamCt extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateParamCt() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			try {
				...
				request.getRequestDispatcher("prep.prepParamCutiRules?atMenu="+scopeCmd).forward(request,response);
			}
			catch(Exception e) {}
