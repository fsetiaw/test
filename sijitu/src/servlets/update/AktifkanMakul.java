...
/**
 * Servlet implementation class AktifkanMakul
 */
@WebServlet("/AktifkanMakul")
public class AktifkanMakul extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
//    public AktifkanMakul() {
//        super();
...
//    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		udb.aktifkanMakul(Integer.valueOf(idkmk).intValue(),request.getRemoteAddr(),isu);
