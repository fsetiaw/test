...
import beans.dbase.feeder.importer.KelasKuliahImporter;
 ...
 */
@WebServlet("/KelasKuliah")
public class KelasKuliah extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String target_thsms = request.getParameter("thsms");
		System.out.println("import kelas kliah "+target_thsms);
		
		KelasKuliahImporter ki = new KelasKuliahImporter(isu.getNpm());
		Vector v_err = ki.importKelasKuliah(target_thsms);
		/*
		 * V_ERR ALWAY NO ERROR UNTUK SAAT INI
		 */
