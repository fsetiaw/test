...
import beans.dbase.feeder.importer.DosenPTImporter;
 ...
 */
@WebServlet("/DosenPT")
public class DosenPT extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String target_thsms = request.getParameter("thsms");
		System.out.println("import dosen_pt "+target_thsms);
		
		//DosenPTImporter ki = new DosenPTImporter(isu.getNpm());
		//ki.importDosenPT(target_thsms);
