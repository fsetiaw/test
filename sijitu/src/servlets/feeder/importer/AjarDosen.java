...
import beans.dbase.feeder.importer.AjarDosenImporter;
 ...
 */
@WebServlet("/AjarDosen")
public class AjarDosen extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String target_thsms = request.getParameter("thsms");
		System.out.println("import ajar dosen "+target_thsms);
		
		AjarDosenImporter ki = new AjarDosenImporter(isu.getNpm());
		Vector v_err = ki.importAjarDosen(target_thsms);
