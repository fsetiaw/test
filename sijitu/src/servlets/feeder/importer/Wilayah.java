...
import beans.dbase.feeder.importer.WilayahImporter;
import beans.login.InitSessionUsr;
import beans.setting.Constants;
import beans.tools.PathFinder;

/**
 * Servlet implementation class Wilayah
 */
@WebServlet("/Wilayah")
public class Wilayah extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("import Wilayah");
		WilayahImporter ki = new WilayahImporter(isu.getNpm());
		//ki.getFixed();
		Vector v_err = ki.syncNegara();
		v_err = ki.syncLvlWilayah();
		v_err = ki.syncWilayah();
		//session.setAttribute("v_err", v_err);
//		Vector v_error = bni.importWilayah();
