...
/**
 * Servlet implementation class RedirectAfterGenericFileUploadAmi
 */
@WebServlet("/RedirectAfterGenericFileUploadAmi")
public class RedirectAfterGenericFileUploadAmi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RedirectAfterGenericFileUploadAmi() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("RedirectAfterGenericFileUploadAmi");
		...
		request.getRequestDispatcher("get.folderContentAmi?at_menu=folder&kdpst="+kdpst+"&root_dir="+root_dir+"&keter="+keter+"&alm="+alm+"&hak="+hak).forward(request,response);
	}
