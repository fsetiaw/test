...
/**
 * Servlet implementation class SebaranTrlsm_v1
 */
@WebServlet("/SebaranTrlsm_v1")
public class SebaranTrlsm_v1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SebaranTrlsm_v1() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			//System.out.println("masuk="+target_thsms);
