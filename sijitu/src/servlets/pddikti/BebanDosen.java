...
/**
 * Servlet implementation class BebanDosen
 */
@WebServlet("/BebanDosen")
public class BebanDosen extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			String target = Constants.getRootWeb()+"/InnerFrame/Pddikti/Dosen/bebanDosen.jsp";
