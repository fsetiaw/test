...
/**
 * Servlet implementation class UpdateRiwayatPengendalianAmi
 */
@WebServlet("/UpdateRiwayatPengendalianAmi")
public class UpdateRiwayatPengendalianAmi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateRiwayatPengendalianAmi() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isu==null) {
			...
			if(v_err!=null) {
				...
				String target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual_pengendalian/riwayat_kendali_ami.jsp";
				...
				int upd = uhk.updateRiwayatPengendalianAmi(id_eval, tgl_kendal, waktu_kendal, rasionale_kendal, tindakan_kendal, npm_kendal, tilang, jenis_pelanggaran);
				String target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual_pengendalian/riwayat_kendali_ami.jsp";
				String uri = request.getRequestURI();
				String url = PathFinder.getPath(uri, target);
				request.getRequestDispatcher(url).forward(request,response);
