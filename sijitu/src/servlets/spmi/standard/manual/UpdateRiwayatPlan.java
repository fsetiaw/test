...
import beans.dbase.spmi.riwayat.pengendalian.UpdHistPlan_deprecated;
...
/**
 * Servlet implementation class UpdateRiwayatPlan
 */
@WebServlet("/UpdateRiwayatPlan")
public class UpdateRiwayatPlan extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateRiwayatPlan() {
        super();
			...
			*/
			...
			if(v_err!=null) {
				...
				if(!Checker.isStringNullOrEmpty(id_plan)) {
					target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual_perencanaan/riwayat_plan.jsp";
				}
				else {
					target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual_perencanaan/form_survey_plan.jsp";
				}
				...
				UpdHistPlan_deprecated uhk = new UpdHistPlan_deprecated();
				...
				String target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual_perencanaan/riwayat_plan.jsp";
				String uri = request.getRequestURI();
				String url = PathFinder.getPath(uri, target);
