 ...
 */
@WebServlet("/UpdateManualPengendalian")
public class UpdateManualPengendalian extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateManualPengendalian() {
        super();
		...
		if(isu==null) {
			...
			if(!Checker.isStringNullOrEmpty(hapus) && hapus.equalsIgnoreCase("true")) {
				...
				if(job_kendali==null || job_kendali.length<1) {
					lir.add("Pihak terkait proses pengendalian belum ditentukan");
					no_err=false;
				}
				...
				if(!no_err) {
					...
					String target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual/form_insert_manual_pengendalian_v1.jsp";
					...
					UpdateManual um =new UpdateManual();
					int updated = um.updateManualPengendalian(mode,no_urut_manual,id_versi,id_std_isi,kdpst,id_versi,id_std_isi,id_std,at_menu_dash,id_kendali,tipe_sarpras,catat_civitas,fwdto,job_rumus,	job_cek,job_stuju,job_tetap,job_kendali,tujuan,lingkup,prosedur,kuali,doc,ref,definisi);
