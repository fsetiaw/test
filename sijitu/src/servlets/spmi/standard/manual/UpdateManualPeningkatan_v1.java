...
/**
 * Servlet implementation class UpdateManualPeningkatan_v1
 */
@WebServlet("/UpdateManualPeningkatan_v1")
public class UpdateManualPeningkatan_v1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateManualPeningkatan_v1() {
        super();
			...
			if(tombol!=null && tombol.equalsIgnoreCase("dok_terkait")) {
				...
				if(!Checker.isStringNullOrEmpty(hapus) && hapus.equalsIgnoreCase("true")) {
					...
					if(!no_err) {
						...
						UpdateManual um =new UpdateManual();
						int updated = um.updateManualPeningkatan_v1(mode, kdpst, id_versi, id_std, at_menu_dash, id_kendali, tipe_sarpras, catat_civitas, fwdto, job_rumus, job_cek, job_stuju, job_tetap, job_kendali, job_survey, tujuan, lingkup, prosedur, kuali, dok_terkait_std, ref, definisi);
