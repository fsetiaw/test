...
/**
 * Servlet implementation class UpdateRiwayatPengendalian
 */
@WebServlet("/UpdateRiwayatPengendalian")
public class UpdateRiwayatPengendalian extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateRiwayatPengendalian() {
        super();
			...
			*/
			...
			if(v_err!=null) {
				...
				if(!Checker.isStringNullOrEmpty(id_plan)) {
					target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual_pengendalian/riwayat_pengendalian.jsp";
				}
				else {
					target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual_pengendalian/form_survey_pengendalian.jsp";
				}
				...
				int updated = uhk.updateRiwayatPengendalian(id_plan,id_versi,id_std_isi,norut_man,form_tgl_sta,form_waktu_sta,form_nmm_kegiatan,form_jenis_kegiatan,form_tujuan_kegiatan,form_isi_kegiatan,form_job_jawab,form_job_target,form_dok_mutu,form_started);
				if(updated<1) {
					if(v_err==null) {
						v_err = new Vector();
						li = v_err.listIterator();
				...
				String target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual_pengendalian/riwayat_pengendalian.jsp";
				String uri = request.getRequestURI();
				String url = PathFinder.getPath(uri, target);
