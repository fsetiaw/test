 ...
 */
@WebServlet("/UpdateManualEvaluasi")
public class UpdateManualEvaluasi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateManualEvaluasi() {
        super();
		...
		if(isu==null) {
			...
			if(!Checker.isStringNullOrEmpty(hapus) && hapus.equalsIgnoreCase("true")) {
				...
				if(!no_err) {
					...
					UpdateManual um =new UpdateManual();
					int updated = um.updateManualEvaluasi(mode,no_urut_manual,id_versi,id_std_isi,kdpst,id_versi,id_std_isi,id_std,at_menu_dash,id_kendali,tipe_sarpras,catat_civitas,fwdto,job_rumus,	job_cek,job_stuju,job_tetap,job_kendali,job_survey,tujuan,lingkup,prosedur,kuali,doc,ref,definisi);
