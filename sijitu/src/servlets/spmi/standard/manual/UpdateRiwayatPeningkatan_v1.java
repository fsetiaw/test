...
/**
 * Servlet implementation class UpdateRiwayatPeningkatan_v1
 */
@WebServlet("/UpdateRiwayatPeningkatan_v1")
public class UpdateRiwayatPeningkatan_v1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateRiwayatPeningkatan_v1() {
        super();
			...
			*/
			...
			if(v_err!=null) {
				...
				if(!Checker.isStringNullOrEmpty(id_plan)) {
					...
					target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual_peningkatan/form_survey_peningkatan_v1.jsp";
				}
				...
				int updated = uhk.updateRiwayatPeningkatanUmum(id_plan,id_versi,id_std,form_tgl_sta,form_waktu_sta,form_nmm_kegiatan,form_jenis_kegiatan,form_tujuan_kegiatan,form_isi_kegiatan,form_job_jawab,form_job_target,form_dok_mutu,form_started);
				if(updated<1) {
					if(v_err==null) {
						v_err = new Vector();
						li = v_err.listIterator();
