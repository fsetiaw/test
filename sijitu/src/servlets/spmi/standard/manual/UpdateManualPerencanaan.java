 ...
 */
@WebServlet("/UpdateManualPerencanaan")
public class UpdateManualPerencanaan extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateManualPerencanaan() {
        super();
		...
		if(isu==null) {
			...
			if(!Checker.isStringNullOrEmpty(hapus) && hapus.equalsIgnoreCase("true")) {
				...
				if(!no_err) {
					...
					String target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual/form_insert_manual_perencanaan.jsp";
