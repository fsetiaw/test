 ...
 */
@WebServlet("/UpdateRiwayatHasilEvaluasi")
public class UpdateRiwayatHasilEvaluasi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateRiwayatHasilEvaluasi() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isu==null) {
			...
			if(v_err!=null) {
				...
				int updated = uhk.updateRiwayatHasilEvaluasi(id_plan, form_hasil, form_note, form_tgl_end, form_waktu_end, form_penetapan_tgl, id_versi, id_std_isi, norut_man);
