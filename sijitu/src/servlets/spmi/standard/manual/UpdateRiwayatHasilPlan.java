...
/**
 * Servlet implementation class UpdateRiwayatHasilPlan
 */
@WebServlet("/UpdateRiwayatHasilPlan")
public class UpdateRiwayatHasilPlan extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateRiwayatHasilPlan() {
        super();
