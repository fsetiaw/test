...
/**
 * Servlet implementation class UpdateManualPelaksanaan
 */
@WebServlet("/UpdateManualPelaksanaan")
public class UpdateManualPelaksanaan extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateManualPelaksanaan() {
        super();
		...
		if(isu==null) {
			...
			if(!Checker.isStringNullOrEmpty(hapus) && hapus.equalsIgnoreCase("true")) {
				...
				if(!no_err) {
					...
					String target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual/form_insert_manual_pelaksanaan.jsp";
					...
					int updated = um.updateManualPelaksanaan(mode,no_urut_manual,id_versi,id_std_isi,kdpst,id_versi,id_std_isi,id_std,at_menu_dash,id_kendali,tipe_sarpras,catat_civitas,fwdto,job_rumus,	job_cek,job_stuju,job_tetap,job_kendali,job_survey,tujuan,lingkup,prosedur,kuali,doc,ref,definisi);
			...
			if(!Checker.isStringNullOrEmpty(hapus) && hapus.equalsIgnoreCase("true")) {
				...
				if(!no_err) {
					...
					UpdateManual um =new UpdateManual();
					int updated = um.UpdateManualPelaksanaan(id_kendali, Integer.parseInt(id_versi), Integer.parseInt(id_std_isi), Integer.parseInt(norut), capaian, ket_proses, manual, null, null, Integer.parseInt(tot_repetisi), satuan, job[0], job_input[0], null, null, tipe_sarpras, Boolean.parseBoolean(catat_civitas));
