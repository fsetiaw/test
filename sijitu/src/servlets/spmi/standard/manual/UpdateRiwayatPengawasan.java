...
/**
 * Servlet implementation class UpdateRiwayatPengawasan
 */
@WebServlet("/UpdateRiwayatPengawasan")
public class UpdateRiwayatPengawasan extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateRiwayatPengawasan() {
        super();
