...
/**
 * Servlet implementation class UpdateManualPerencanaan_v1
 */
@WebServlet("/UpdateManualPerencanaan_v1")
public class UpdateManualPerencanaan_v1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateManualPerencanaan_v1() {
        super();
			...
			if(tombol!=null && tombol.equalsIgnoreCase("dok_terkait")) {
				...
				if(!Checker.isStringNullOrEmpty(hapus) && hapus.equalsIgnoreCase("true")) {
					...
					if(!no_err) {
						...
						String target = Constants.getRootWeb()+"/InnerFrame/Spmi/standar_spmi/form_manual/form_insert_manual_perencanaan_v1.jsp";
						String uri = request.getRequestURI();
						String url = PathFinder.getPath(uri, target);
						...
						UpdateManual um =new UpdateManual();
						int updated = um.updateManualPerencanaan_v1(mode, kdpst, id_versi, id_std, at_menu_dash, id_kendali, tipe_sarpras, catat_civitas, fwdto, job_rumus, job_cek, job_stuju, job_tetap, job_kendali, job_survey, tujuan, lingkup, prosedur, kuali, dok_terkait_std, ref, definisi);
						//int updated = um.updateManualPerencanaan(mode,no_urut_manual,id_versi,id_std_isi,kdpst,id_versi,id_std_isi,id_std,at_menu_dash,id_kendali,tipe_sarpras,catat_civitas,fwdto,job_rumus,	job_cek,job_stuju,job_tetap,job_kendali,job_survey,tujuan,lingkup,prosedur,kuali,doc,ref,definisi);
