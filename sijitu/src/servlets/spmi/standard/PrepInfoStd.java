...
/**
 * Servlet implementation class PrepInfoStd
 */
@WebServlet("/PrepInfoStd")
public class PrepInfoStd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//PrintWriter oString kdpst_nmpst_kmp= request.getParameter("kdpst_nmpst_kmp");
			...
			request.getRequestDispatcher(url+"?pengawas="+pengawas+"&terkait="+terkait).forward(request,response);
		}
	}
