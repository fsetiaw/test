...
/**
 * Servlet implementation class UbahUsulanJadiStandar
 */
@WebServlet("/UbahUsulanJadiStandar")
public class UbahUsulanJadiStandar extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UbahUsulanJadiStandar() {
        super();
