 ...
 */
@WebServlet("/UsulanStandarIsi")
public class UsulanStandarIsi extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UsulanStandarIsi() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//kode here
			...
			String[]grup_job = request.getParameterValues("grup_job");
			...
			int updated = uf.insertNuStandarIsi(job, grup_job, isi_std, doc, rasionale);
			...
			request.getRequestDispatcher(url+"?kdpst_nmpst_kmp="+kdpst_nmpst_kmp+"&updated="+updated).forward(request,response);
		}
	}
