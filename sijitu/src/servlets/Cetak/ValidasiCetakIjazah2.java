...
/**
 * Servlet implementation class ValidasiCetakIjazah2
 */
@WebServlet("/ValidasiCetakIjazah2")
public class ValidasiCetakIjazah2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidasiCetakIjazah2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean pass = false;
		/*
		 * taruh filter /requirement bila ada disini
		 */
		pass = true;
		if(pass) {
			String target = Constants.getRootWeb()+"/InnerFrame/downloadExcelIjazah.jsp";
